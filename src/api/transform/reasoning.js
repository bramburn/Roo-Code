...
export const getOpenRouterReasoning = ({ model, reasoningBudget, reasoningEffort, settings }) =>
...
export const getAnthropicReasoning = ({ model, reasoningBudget, settings }) =>
...
export const getGeminiReasoning = ({ model, reasoningBudget, settings }) =>
	shouldUseReasoningBudget({ model, settings })
