...
import { modelIdKeysByProvider, isProviderName, isDynamicProvider, isFauxProvider, isCustomProvider, } from "@roo-code/types";
export function validateApiConfiguration(apiConfiguration, routerModels, organizationAllowList) {
    ...
    const organizationAllowListError = validateProviderAgainstOrganizationSettings(apiConfiguration, organizationAllowList);
...
function validateModelsAndKeysProvided(apiConfiguration) {
...
function validateProviderAgainstOrganizationSettings(apiConfiguration, organizationAllowList) {
...
function getModelIdForProvider(apiConfiguration, provider) {
 ...
 */
export function validateBedrockArn(arn, region) {
    // Validate ARN format.
...
function validateDynamicProviderModelId(apiConfiguration, routerModels) {
    const provider = apiConfiguration.apiProvider ?? "";
 ...
 */
export function getModelValidationError(apiConfiguration, routerModels, organizationAllowList) {
 ...
 */
export function validateApiConfigurationExcludingModelErrors(apiConfiguration, _routerModels, // Keeping this for compatibility with the old function.
