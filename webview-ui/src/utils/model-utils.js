 ...
 */
export const calculateTokenDistribution = (contextWindow, contextTokens, maxTokens) => {
    ...
    const reservedForOutput = maxTokens && maxTokens > 0 && maxTokens !== safeContextWindow ? maxTokens : ANTHROPIC_DEFAULT_MAX_TOKENS;
