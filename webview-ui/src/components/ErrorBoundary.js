...
class ErrorBoundary extends Component {
	...
	render() {
		...
		return _jsxs("div", {
			children: [
				_jsxs("h2", {
					className: "text-lg font-bold mt-0 mb-2",
					children: [t("errorBoundary.title"), " (v", version, ")"],
				}),
				_jsxs("p", {
					className: "mb-4",
					children: [
						...
						_jsx("a", {
							...
							target: "_blank",
							rel: "noreferrer",
							children: t("errorBoundary.githubText"),
						}),
					],
				}),
				_jsx("p", { className: "mb-2", children: t("errorBoundary.copyInstructions") }),
				_jsxs("div", {
					className: "mb-4",
					children: [
						_jsx("h3", { className: "text-md font-bold mb-1", children: t("errorBoundary.errorStack") }),
						_jsx("pre", { className: "p-2 border rounded text-sm overflow-auto", children: errorDisplay }),
					],
				}),
					...
					_jsxs("div", {
						children: [
							_jsx("h3", {
								...
								children: t("errorBoundary.componentStack"),
							}),
							_jsx("pre", {
								className: "p-2 border rounded text-sm overflow-auto",
								children: componentStackDisplay,
							}),
						],
					}),
			],
