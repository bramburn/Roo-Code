...
const TaskItem = ({
	...
	return _jsx(
		"div",
		{
			...
			onClick: handleClick,
			children: _jsxs("div", {
				className: (!isCompact && isSelectionMode ? "pl-3 pb-3" : "pl-4") + " flex gap-3 px-3 pt-3 pb-1",
				children: [
					!isCompact &&
						isSelectionMode &&
						_jsx("div", {
					...
					_jsxs("div", {
						...
						children: [
							_jsx("div", {
								...
								children: item.highlight ? undefined : item.task,
							}),
							_jsx(TaskItemFooter, {
								item: item,
								variant: variant,
							...
							showWorkspace &&
								item.workspace &&
								_jsxs("div", {
									className: "flex flex-row gap-1 text-vscode-descriptionForeground text-xs mt-1",
									children: [
										_jsx("span", { className: "codicon codicon-folder scale-80" }),
										_jsx("span", { children: item.workspace }),
									],
								}),
						],
					}),
