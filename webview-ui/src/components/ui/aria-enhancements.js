...
export const AriaEnhancementProvider = ({
	children,
	...
	return _jsxs(AriaContext.Provider, {
		value: contextValue,
		children: [
			children,
			enableLiveRegions &&
		...
		children: items.map((item, index) =>
			_jsxs(
				"li",
				{
					...
					children: [
						_jsx("div", { className: "font-medium", children: item.label }),
						item.description &&
							_jsx("div", { className: "text-sm text-gray-600", children: item.description }),
					],
				},
				item.id,
			),
...
export const ScreenReaderOnly = ({ children }) =>
	_jsx("div", { className: "sr-only", "aria-hidden": "false", children: children })
/**
 * Skip to main content link
 */
export const SkipToMain = ({ mainId, label = "Skip to main content" }) =>
	_jsx("a", {
		href: `#${mainId}`,
		className:
			"sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 z-50 bg-blue-600 text-white px-4 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-300",
		children: label,
	})
