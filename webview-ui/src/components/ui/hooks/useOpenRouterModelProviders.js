...
async function getOpenRouterProvidersForModel(modelId) {
    const models = {};
    try {
...
export const useOpenRouterModelProviders = (modelId, options) => useQuery({
    queryKey: ["openrouter-model-providers", modelId],
    queryFn: () => (modelId ? getOpenRouterProvidersForModel(modelId) : {}),
    ...options,
});
//# sourceMappingURL=useOpenRouterModelProviders.js.map