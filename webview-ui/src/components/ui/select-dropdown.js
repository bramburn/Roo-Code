...
export const SelectDropdown = React.memo(
	React.forwardRef(
		(
			...
			const triggerContent = _jsxs(PopoverTrigger, {
				ref: ref,
				disabled: disabled,
				...
				children: [
					_jsx(CaretUpIcon, { className: "pointer-events-none opacity-80 flex-shrink-0 size-3" }),
					_jsx("span", { className: "truncate", children: displayText }),
				],
			})
			return _jsxs(Popover, {
				...
				children: [
					title ? _jsx(StandardTooltip, { content: title, children: triggerContent }) : triggerContent,
					_jsx(PopoverContent, {
						align: align,
