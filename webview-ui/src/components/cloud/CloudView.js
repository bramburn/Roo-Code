			...
			_jsxs(TabHeader, {
				...
				children: [
					_jsx("h3", {
						...
						children: isAuthenticated && t("cloud:title"),
					}),
					_jsx(Button, { onClick: onDone, children: t("settings:common.done") }),
				],
			}),
			_jsxs(TabContent, {
				className: "pt-10",
				children: [
					isAuthenticated
						? _jsxs(_Fragment, {
								children: [
									userInfo &&
										_jsxs("div", {
											className: "flex flex-col items-start ml-4 mb-6",
											children: [
												_jsx("div", {
													className: "w-16 h-16 mb-3 rounded-full overflow-hidden",
													children: userInfo?.picture
														? _jsx("img", {
														...
														: _jsx("div", {
																className:
																	"w-full h-full flex items-center justify-center bg-vscode-button-background text-vscode-button-foreground text-xl",
																children:
												...
												userInfo.name &&
													_jsx("h2", {
														className: "text-lg font-medium text-vscode-foreground my-0",
												...
												_jsx("div", {
													className: "w-full max-w-60 mt-4",
													children: _jsx(OrganizationSwitcher, {
														userInfo: userInfo,
									...
									_jsxs("div", {
										className:
											"mt-4 p-4 border-b border-t border-vscode-widget-border pl-4 max-w-140",
										children: [
											_jsxs("div", {
												...
												children: [
													...
													_jsxs("span", {
														className:
															"font-medium text-vscode-foreground flex items-center",
														children: [
															t("cloud:taskSync"),
															userInfo?.organizationId &&
																_jsx(StandardTooltip, {
																	...
																	children: _jsx("div", {
																		className:
																			"bg-vscode-badge-background text-vscode-badge-foreground/80 p-1.5 ml-2 -mb-2 relative -top-1 rounded-full inline-block cursor-help",
																		children: _jsx(Lock, {
											...
											_jsx("div", {
												className: "text-vscode-descriptionForeground text-sm mt-1 ml-8",
												children: t("cloud:taskSyncDescription"),
											}),
														...
														_jsxs("div", {
															...
															children: [
																...
																_jsx("span", {
																	...
																	children: t("cloud:remoteControl"),
																}),
															],
														}),
														_jsxs("div", {
															className:
																"text-vscode-descriptionForeground text-sm mt-1 mb-2 ml-8",
															children: [
																t("cloud:remoteControlDescription"),
																!taskSyncEnabled &&
																	_jsxs("div", {
																		className:
																			"text-vscode-editorWarning-foreground mt-2",
																		children: [
																			_jsx(CircleAlert, {
																				className:
																					"inline size-3 mr-1 mb-0.5 text-vscode-editorWarning-foreground",
																			}),
									...
									_jsxs("div", {
										className: "text-vscode-descriptionForeground text-sm mt-4 mb-8 pl-4",
										children: [
											_jsx(Info, {
												className:
													"inline size-3 mr-1 mb-0.5 text-vscode-descriptionForeground",
											}),
											t("cloud:usageMetricsAlwaysReported"),
										],
									}),
									_jsxs("div", {
										className: "flex flex-col gap-2 mt-4 pl-4",
										children: [
											_jsx(VSCodeButton, {
												appearance: "secondary",
												onClick: handleVisitCloudWebsite,
												className: "w-full max-w-80",
												children: t("cloud:visitCloudWebsite"),
											}),
											_jsx(VSCodeButton, {
												appearance: "secondary",
												onClick: handleLogoutClick,
												className: "w-full max-w-80",
												children: t("cloud:logOut"),
											}),
										],
									}),
								],
						...
						: _jsx(_Fragment, {
								children: _jsxs("div", {
									className: "flex flex-col items-start gap-4 px-8 max-w-100",
									children: [
										_jsx("div", {
											className: cn(authInProgress && "opacity-50"),
											children: renderCloudBenefitsContent(t),
										}),
										!authInProgress &&
											_jsx(VSCodeButton, {
												appearance: "primary",
										...
										authInProgress &&
											...
											_jsxs("div", {
												...
												children: [
													_jsxs("div", {
														className:
															"flex items-center gap-2 text-base text-vscode-descriptionForeground",
														children: [
															_jsx(VSCodeProgressRing, {
																className: "size-3 text-vscode-foreground",
															}),
															t("cloud:authWaiting"),
														],
													}),
													!showManualEntry &&
														_jsx("button", {
															...
															className:
																"text-base ml-5 text-vscode-textLink-foreground hover:text-vscode-textLink-activeForeground underline cursor-pointer bg-transparent border-none p-0",
															children: t("cloud:havingTrouble"),
														}),
												],
											}),
										showManualEntry &&
											...
											_jsxs("div", {
												className: "space-y-2 max-w-72",
												children: [
													_jsx("p", {
														className: "text-base text-vscode-descriptionForeground",
														children: t("cloud:pasteCallbackUrl"),
													}),
													_jsx(VSCodeTextField, {
														...
														placeholder:
															"vscode://RooVeterinaryInc.roo-cline/auth/clerk/callback?state=...",
														className: "w-full",
													}),
													_jsxs("p", {
														className: "mt-1",
														children: [
															...
															_jsx("button", {
																onClick: handleReset,
																className:
																	"text-base text-vscode-textLink-foreground hover:text-vscode-textLink-activeForeground underline cursor-pointer bg-transparent border-none p-0",
																children: t("cloud:startOver"),
															}),
														],
													}),
												],
					...
					cloudApiUrl &&
						cloudApiUrl !== PRODUCTION_ROO_CODE_API_URL &&
						_jsx("div", {
							className: "ml-4 mt-6 flex",
							children: _jsxs("div", {
								className: "inline-flex items-center gap-2 text-xs",
								children: [
									_jsx(TriangleAlert, { className: "size-3 text-vscode-descriptionForeground" }),
									_jsxs("span", {
										className: "text-vscode-foreground/75",
										children: [t("cloud:cloudUrlPillLabel"), " "],
									}),
									_jsx("button", {
										onClick: handleOpenCloudUrl,
										className:
											"text-vscode-textLink-foreground hover:text-vscode-textLink-activeForeground underline cursor-pointer bg-transparent border-none p-0",
										children: cloudApiUrl,
									}),
								],
							}),
						}),
