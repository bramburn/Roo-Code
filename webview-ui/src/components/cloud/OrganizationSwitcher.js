							...
							children: selectedOrgId
								...
								: _jsxs(_Fragment, {
										children: [
											_jsx("div", {
												className:
													"p-0.5 bg-vscode-button-background rounded-full flex items-center justify-center text-vscode-button-foreground text-xs",
												children: _jsx(User, {
					...
					children: [
						_jsx(SelectItem, {
							...
							children: _jsxs("div", {
								className: "flex items-center gap-2",
								children: [
									_jsx(User, { className: "w-4.5 h-4.5" }),
									_jsx("span", { children: t("cloud:personalAccount") }),
								],
							}),
						}),
						organizations.length > 0 && _jsx(SelectSeparator, {}),
