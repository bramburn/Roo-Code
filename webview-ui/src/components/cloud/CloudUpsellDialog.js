...
export const renderCloudBenefitsContent = (t) => {
	return _jsxs("div", {
		...
		children: [
			_jsx("div", { className: "w-15", children: _jsx(RooHero, {}) }),
			_jsx("h1", {
				className: "text-xl font-bold text-vscode-foreground",
				children: t("cloud:cloudBenefitsTitle"),
			}),
			_jsx("div", {
				className: "text-lg",
				children: _jsxs("ul", {
					className: "text-vscode-descriptionForeground space-y-4 my-8",
					children: [
						_jsxs("li", {
							className: "flex items-start gap-2",
							children: [
								_jsx(Router, { className: "size-4 mt-0.5 shrink-0" }),
						...
						_jsxs("li", {
							className: "flex items-start gap-2",
							children: [
								_jsx(Share, { className: "size-4 mt-0.5 shrink-0" }),
						...
						_jsxs("li", {
							className: "flex items-start gap-2",
							children: [
								_jsx(CircleDollarSign, { className: "size-4 mt-0.5 shrink-0" }),
						...
						_jsxs("li", {
							className: "flex items-start gap-2",
							children: [
								_jsx(FileStack, { className: "size-4 mt-0.5 shrink-0" }),
...
export const CloudUpsellDialog = ({ open, onOpenChange, onConnect }) => {
	...
	return _jsx(Dialog, {
		...
		children: _jsxs(DialogContent, {
			className: "max-w-sm",
			children: [
				_jsx(DialogHeader, { children: _jsx(DialogTitle, {}) }),
				_jsxs("div", {
