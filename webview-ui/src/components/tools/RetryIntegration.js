			...
			_jsxs("div", {
				...
				children: [
					_jsxs("button", {
						...
						children: [_jsx(RefreshCw, { className: "w-4 h-4 mr-2" }), t("retryStatus.progress.label")],
					}),
					showErrorRecovery &&
						_jsxs("button", {
							...
							children: [_jsx(AlertTriangle, { className: "w-4 h-4 mr-2" }), t("recovery.errorOccurred")],
						}),
					showMetrics &&
						_jsxs("button", {
							...
							children: [_jsx(BarChart3, { className: "w-4 h-4 mr-2" }), "Metrics"],
						}),
					showSettings &&
						_jsxs("button", {
							...
							children: [_jsx(Settings, { className: "w-4 h-4 mr-2" }), t("retry.title")],
						}),
				],
			}),
			_jsxs("div", {
				...
				children: [
						...
						_jsxs("div", {
							...
							children: [
								_jsx("h3", {
									...
									children: t("retryStatus.progress.label"),
								}),
								retryState
									? _jsxs(_Fragment, {
											children: [
													...
													children: [
														retryState.isActive &&
															_jsx("button", {
																...
																className:
																	"px-3 py-2 text-sm font-medium text-red-700 dark:text-red-300 bg-red-100 dark:bg-red-900 rounded hover:bg-red-200 dark:hover:bg-red-800 transition-colors",
														...
														contextOptimizationAvailable &&
															_jsx("button", {
																...
																className:
																	"px-3 py-2 text-sm font-medium text-blue-700 dark:text-blue-300 bg-blue-100 dark:bg-blue-900 rounded hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors",
																children: "Optimize Context",
															}),
													],
												}),
												_jsx(RetryProgressIndicator, {
													retryState: retryState,
													className: "mt-4",
												}),
											],
									...
									: _jsxs("div", {
											...
											children: [
												_jsx(RefreshCw, { className: "w-8 h-8 mx-auto mb-4 text-gray-300" }),
												_jsx("p", {
													className: "text-lg font-medium",
													children: "No retry operations in progress",
												}),
												_jsx("p", {
													className: "text-sm",
													children:
					...
					activeTab === "metrics" &&
						...
						_jsx("div", {
							className: "p-4",
							children: _jsx(RetryMetricsPanel, { metrics: metrics, history: history }),
						}),
					activeTab === "settings" &&
						showSettings &&
						_jsxs("div", {
								...
								_jsxs("div", {
									...
									children: [
										_jsx("h3", {
											...
											children: t("retry.title"),
										}),
										_jsx("p", {
											className: "text-sm text-gray-600 dark:text-gray-400",
											children: t("retry.description"),
										}),
									],
								}),
								_jsx(RetrySettingsPanel, {
									settings: retrySettings,
									onSettingsChange: onRetrySettingsChange,
								}),
							],
						}),
				],
