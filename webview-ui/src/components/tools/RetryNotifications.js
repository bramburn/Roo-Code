...
export const RetryNotifications = ({ notifications, retryStates, onDismissNotification, className = "" }) => {
	...
	return _jsx("div", {
		className: `fixed top-4 right-4 z-50 space-y-2 max-w-sm ${className}`,
		children: visibleNotifications.map((notification) =>
			_jsxs(
				"div",
				{
					className: `flex items-start gap-3 p-3 rounded-lg border shadow-lg cursor-pointer transition-all duration-200 hover:shadow-xl ${getNotificationColor(notification.type)}`,
							...
							children: [
								_jsxs("div", {
									...
									children: [
										_jsx("p", {
											...
											children: formatNotificationMessage(notification),
										}),
										_jsx("button", {
											onClick: (e) => {
												e.stopPropagation()
											...
											className:
												"flex-shrink-0 ml-2 text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300",
								...
								notification.data &&
									_jsxs("div", {
										...
										children: [
											notification.data.toolName &&
												_jsxs("span", { children: ["Tool: ", notification.data.toolName] }),
											notification.data.attempt !== undefined &&
												_jsxs("span", {
													className: "ml-2",
													children: [
														"Attempt: ",
														notification.data.attempt,
	...
	return _jsxs("div", {
		...
		children: [
			_jsx("div", {
				...
				children: _jsx(RefreshCw, { className: "w-5 h-5 text-blue-500 animate-spin" }),
			}),
			_jsxs("div", {
				className: "flex-1",
				children: [
					_jsxs("div", {
						...
						children: [
							_jsxs("span", {
								...
								children: ["Retrying ", retryState.toolName, "..."],
							}),
							_jsxs("span", {
								className: "text-sm text-blue-700 dark:text-blue-300",
								children: [retryState.currentAttempt, "/", retryState.maxAttempts],
							}),
						],
					}),
					_jsx("div", {
						className: "w-full bg-blue-200 dark:bg-blue-800 rounded-full h-2 mb-2",
						children: _jsx("div", {
					...
					timeRemaining > 0 &&
						_jsxs("div", {
							...
							children: [
								_jsx(Zap, { className: "w-3 h-3" }),
								_jsxs("span", { children: ["Next retry in ", formatTime(timeRemaining)] }),
							],
						}),
					retryState.errors.length > 0 &&
						_jsx("div", {
							className:
								"mt-2 p-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded text-xs",
							children: _jsxs("p", {
								className: "text-red-800 dark:text-red-200",
								children: ["Last error: ", retryState.errors[retryState.errors.length - 1]],
							}),
						}),
				],
			}),
