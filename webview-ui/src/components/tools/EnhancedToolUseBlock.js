...
export const EnhancedToolUseBlock = memo(({ children, retryState, showRetryStatus = false, className }) => {
	...
	const _t = t
	return _jsxs("div", {
		className: cn("border border-vscode-panel-border rounded-md p-2", className),
		children: [
			_jsx(ToolUseBlockHeader, { className: "mb-3" }),
			showRetryStatus &&
				retryState &&
				_jsx(RetryStatus, { retryState: retryState, showDetails: true, className: "mb-4" }),
			_jsx(ToolUseBlock, { children: children }),
		],
	})
})
