...
export const RetryStatus = ({ retryState, variant = "default", showDetails = false, className = "" }) => {
	...
	const getStatusIcon = () => {
		if (!retryState) return _jsx(Clock, { className: "w-4 h-4" })
					...
					children: [
						...
						retryState &&
							_jsxs("span", {
								...
								children: ["Attempt ", retryState.currentAttempt, " of ", retryState.maxAttempts],
							}),
					],
				}),
				retryState &&
							...
							retryState.isActive &&
								...
								_jsxs("div", {
									...
									children: [
										...
										_jsxs("span", { children: ["Next retry in ", formatTime(timeUntilNext)] }),
									],
								}),
							(showDetails || retryState.errors.length > 0) &&
								_jsxs("div", {
									className: "mt-3 p-3 bg-gray-50 dark:bg-gray-900 rounded-md",
									children: [
										_jsxs("div", {
											className: "flex items-center gap-2 mb-2",
											children: [
												_jsx(AlertCircle, { className: "w-4 h-4 text-yellow-500" }),
												_jsx("span", {
										...
										_jsx("p", {
											...
											children: retryState.originalError,
										}),
										retryState.errors.length > 1 &&
											_jsxs("div", {
												...
												children: [
													"Previous attempts: ",
													retryState.errors.slice(0, -1).join(", "),
												],
											}),
									],
								}),
	...
	const renderCompactVariant = () =>
		_jsxs("div", {
			className: `flex items-center gap-2 p-2 border rounded bg-white dark:bg-gray-800 ${className}`,
			children: [
				getStatusIcon(),
				retryState
					? _jsxs(_Fragment, {
