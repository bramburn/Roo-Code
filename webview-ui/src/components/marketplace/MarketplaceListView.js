	...
	return _jsxs(_Fragment, {
		children: [
			_jsxs("div", {
				...
				children: [
					...
					_jsxs("div", {
						...
						children: [
							_jsxs(Select, {
								...
								children: [
									_jsx(SelectTrigger, { className: "flex-1 h-7", children: _jsx(SelectValue, {}) }),
									_jsxs(SelectContent, {
										children: [
											_jsx(SelectItem, {
												value: "all",
												children: t("marketplace:filters.installed.all"),
											}),
											_jsx(SelectItem, {
												value: "installed",
												children: t("marketplace:filters.installed.installed"),
											}),
											_jsx(SelectItem, {
												value: "not_installed",
												children: t("marketplace:filters.installed.notInstalled"),
											}),
										],
									}),
								],
											...
											_jsx(PopoverContent, {
												...
												children: _jsxs(Command, {
													children: [
														_jsxs("div", {
															...
															children: [
																_jsx(CommandInput, {
																	className: "h-9 pr-8",
																	placeholder: t(
																		"marketplace:filters.tags.placeholder",
																	),
																	value: tagSearch,
														...
														_jsxs(CommandList, {
															className:
																"max-h-[200px] overflow-y-auto bg-vscode-dropdown-background divide-y divide-vscode-panel-border",
															children: [
																_jsx(CommandEmpty, {
																	className:
																		"p-2 text-sm text-vscode-descriptionForeground",
																	children: t("marketplace:filters.tags.noResults"),
																}),
																_jsx(CommandGroup, {
																		...
																		_jsxs(
																			CommandItem,
																			{
																				...
																				"data-selected":
																					state.filters.tags.includes(tag),
																				className:
																					"grid grid-cols-[1rem_1fr] gap-2 cursor-pointer text-sm capitalize",
																				onMouseDown: (e) => {
																					e.stopPropagation()
																					e.preventDefault()
																				},
					...
					state.filters.tags.length > 0 &&
						_jsxs("div", {
							className:
								"text-xs text-vscode-descriptionForeground mt-2 flex items-center justify-between",
							children: [
								_jsxs("div", {
									className: "flex items-center",
									children: [
										_jsx("span", { className: "codicon codicon-tag mr-1" }),
										t("marketplace:filters.tags.selected"),
									],
								}),
								_jsxs(Button, {
									className:
										"shadow-none font-normal flex items-center gap-1 h-auto py-0.5 px-1.5 text-xs",
									size: "sm",
									variant: "secondary",
									onClick: (e) => {
										e.stopPropagation()
									...
									children: [
										_jsx("span", { className: "codicon codicon-close" }),
			...
			state.isFetching &&
				...
				_jsxs("div", {
					className:
						"flex flex-col items-center justify-center h-64 text-vscode-descriptionForeground animate-fade-in",
					children: [
						_jsx("div", {
							className: "animate-spin mb-4",
							children: _jsx("span", { className: "codicon codicon-sync text-3xl" }),
						}),
						_jsx("p", { children: t("marketplace:items.refresh.refreshing") }),
						_jsx("p", {
							className: "text-sm mt-2 animate-pulse",
							children: t("marketplace:items.refresh.mayTakeMoment"),
						}),
					],
				}),
			!state.isFetching &&
				...
				_jsxs("div", {
					className:
						"flex flex-col items-center justify-center h-64 text-vscode-descriptionForeground animate-fade-in",
					children: [
						_jsx("span", { className: "codicon codicon-inbox text-4xl mb-4 opacity-70" }),
						_jsx("p", { className: "font-medium", children: t("marketplace:items.empty.noItems") }),
						_jsx("p", { className: "text-sm mt-2", children: t("marketplace:items.empty.adjustFilters") }),
						_jsxs(Button, {
							onClick: () =>
								manager.transition({
									type: "UPDATE_FILTERS",
							...
							className:
								"mt-4 bg-vscode-button-secondaryBackground text-vscode-button-secondaryForeground hover:bg-vscode-button-secondaryHoverBackground transition-colors",
							children: [
								_jsx("span", { className: "codicon codicon-clear-all mr-2" }),
							...
							_jsxs("div", {
								...
								children: [
									_jsxs("div", {
										...
										children: [
											_jsx("span", { className: "codicon codicon-organization text-lg" }),
											_jsx("h3", {
												className: "text-sm font-semibold text-vscode-foreground",
												children: t("marketplace:sections.organizationMcps", {
													organization: cloudUserInfo?.organizationName,
												}),
											}),
											_jsx("div", { className: "flex-1 h-px bg-vscode-input-border" }),
										],
									}),
									_jsx("div", {
										className:
											"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-3",
										children: orgMcps.map((item) =>
											_jsx(
												MarketplaceItemCard,
												{
													item: item,
								...
								children: [
									orgMcps.length > 0 &&
										_jsxs("div", {
											className: "flex items-center gap-2 mb-3 px-1",
											children: [
												_jsx("span", { className: "codicon codicon-globe text-lg" }),
												_jsx("h3", {
													className: "text-sm font-semibold text-vscode-foreground",
													children: t("marketplace:sections.marketplace"),
												}),
												_jsx("div", { className: "flex-1 h-px bg-vscode-input-border" }),
											],
										}),
