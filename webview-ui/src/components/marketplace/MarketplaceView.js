...
export function MarketplaceView({ stateManager, onDone, targetTab }) {
	...
	const [lastOrganizationSettingsVersion, setLastOrganizationSettingsVersion] = useState(
				...
				_jsxs(TabHeader, {
					...
					children: [
						_jsxs("div", {
							...
							children: [
								_jsx("h3", { className: "font-bold m-0", children: t("marketplace:title") }),
								_jsx("div", {
						...
						_jsx("div", {
							...
							children: _jsxs("div", {
								...
								children: [
									_jsx("div", {
										className: "absolute w-full h-[2px] -bottom-[2px] bg-vscode-input-border",
										children: _jsx("div", {
											className: cn(
									...
									_jsx("button", {
										className:
											"flex items-center justify-center gap-2 flex-1 text-sm font-medium rounded-sm transition-colors duration-300 relative z-10 text-vscode-foreground",
										onClick: () =>
