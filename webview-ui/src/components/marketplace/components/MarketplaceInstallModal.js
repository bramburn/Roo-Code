							...
							children: installationComplete
								...
								: item.type === "mcp" && item.url
									? _jsx("a", {
											...
											children: t("marketplace:install.moreInfoMcp", { name: item.name }),
										})
									: null,
						}),
					],
							...
							children: _jsxs("div", {
								...
								children: [
									_jsxs("div", {
										...
										children: ["\u2713 ", t("marketplace:install.installed")],
									}),
									_jsx("p", {
						...
						_jsxs("div", {
							...
							children: [
								_jsxs("div", {
									...
									children: [
										_jsx("div", {
											...
											children: t("marketplace:install.scope"),
										}),
										_jsxs("div", {
											className: "space-y-2",
											children: [
												_jsxs("label", {
													...
													children: [
														...
														_jsx("span", {
															className: !hasWorkspace ? "opacity-50" : "",
															children: t("marketplace:install.project"),
														}),
													],
												}),
												_jsxs("label", {
													...
													children: [
														...
														_jsx("span", { children: t("marketplace:install.global") }),
													],
												}),
											],
										}),
								...
								hasMultipleMethods &&
									_jsxs("div", {
										...
										children: [
											_jsx("div", {
												className: "text-base font-semibold",
												children: t("marketplace:install.method"),
											}),
											_jsxs(Select, {
												...
												children: [
													...
													_jsx(SelectContent, {
														children: methodNames.map((name, index) =>
															_jsx(
																SelectItem,
																{ value: String(index), children: name },
																index,
															),
														),
													}),
								...
								effectivePrerequisites.length > 0 &&
									_jsxs("div", {
										...
										children: [
											_jsx("div", {
												className: "text-base font-semibold",
												children: t("marketplace:install.prerequisites"),
											}),
											_jsx("ul", {
												className: "list-disc list-inside space-y-1 text-sm",
												children: effectivePrerequisites.map((prereq, index) =>
													_jsx(
														"li",
														{ className: "text-muted-foreground", children: prereq },
														index,
													),
												),
											}),
										...
										children: [
											_jsxs("div", {
												...
												children: [
													...
													_jsx("div", {
														className: "text-sm text-muted-foreground",
														children: t("marketplace:install.configurationDescription"),
													}),
												],
											}),
								...
								validationError &&
									_jsx("div", {
										className:
											"text-sm text-red-500 bg-red-500/10 border border-red-500/20 rounded p-2",
					...
					children: installationComplete
						? _jsxs(_Fragment, {
								children: [
									_jsx(Button, {
										variant: "outline",
										onClick: onClose,
										children: t("marketplace:install.done"),
									}),
									_jsx(Button, {
						...
						: _jsxs(_Fragment, {
								children: [
									...
									_jsx(Button, { onClick: handleInstall, children: t("marketplace:install.button") }),
								],
							}),
				}),
			],
