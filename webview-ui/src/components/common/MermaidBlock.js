...
export default function MermaidBlock({ code }) {
    ...
    return (_jsxs(MermaidBlockContainer, { children: [isLoading && _jsx(LoadingMessage, { children: t("common:mermaid.loading") }), error ? (_jsxs("div", { style: { marginTop: "0px", overflow: "hidden", marginBottom: "8px" }, children: [_jsxs("div", { style: {
                            ...
                            cursor: "pointer",
                        }, onClick: () => setIsErrorExpanded(!isErrorExpanded), children: [_jsxs("div", { style: {
                                    display: "flex",
                                    alignItems: "center",
                                    gap: "10px",
                                    flexGrow: 1,
                                }, children: [_jsx("span", { className: "codicon codicon-warning", style: {
                                            color: "var(--vscode-editorWarning-foreground)",
                                            opacity: 0.8,
                                            fontSize: 16,
                                            marginBottom: "-1.5px",
                                        } }), _jsx("span", { style: { fontWeight: "bold" }, children: t("common:mermaid.render_error") })] }), _jsxs("div", { style: { display: "flex", alignItems: "center" }, children: [_jsx(CopyButton, { onClick: (e) => {
                                            e.stopPropagation();
                                            const combinedContent = `Error: ${error}\n\n\`\`\`mermaid\n${code}\n\`\`\``;
                                            copyWithFeedback(combinedContent, e);
                                        }, children: _jsx("span", { className: `codicon codicon-${showCopyFeedback ? "check" : "copy"}` }) }), _jsx("span", { className: `codicon codicon-chevron-${isErrorExpanded ? "up" : "down"}` })] })] }), isErrorExpanded && (_jsxs("div", { style: {
                            padding: "8px",
                            backgroundColor: "var(--vscode-editor-background)",
                            borderTop: "none",
                        }, children: [_jsx("div", { style: { marginBottom: "8px", color: "var(--vscode-descriptionForeground)" }, children: error }), _jsx(CodeBlock, { language: "mermaid", source: code })] }))] })) : (_jsx(MermaidButton, { containerRef: containerRef, code: code, isLoading: isLoading, svgToPng: svgToPng, children: _jsx(SvgContainer, { onClick: handleClick, ref: containerRef, "$isLoading": isLoading }) }))] }));
}
