...
export default function MermaidBlock({ code }) {
	...
	return _jsxs(MermaidBlockContainer, {
		children: [
			isLoading && _jsx(LoadingMessage, { children: t("common:mermaid.loading") }),
			error
				? _jsxs("div", {
						style: { marginTop: "0px", overflow: "hidden", marginBottom: "8px" },
						children: [
							_jsxs("div", {
								style: {
									...
									_jsxs("div", {
										...
										children: [
											...
											_jsx("span", {
												...
												children: t("common:mermaid.render_error"),
											}),
										],
									}),
									_jsxs("div", {
							...
							isErrorExpanded &&
								_jsxs("div", {
									...
									children: [
										...
										_jsx(CodeBlock, { language: "mermaid", source: code }),
									],
								}),
						],
					})
