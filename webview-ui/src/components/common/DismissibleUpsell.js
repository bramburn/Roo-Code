...
const DismissIcon = () => (_jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true", children: _jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M8 8.707l3.646 3.647.708-.707L8.707 8l3.647-3.646-.707-.708L8 7.293 4.354 3.646l-.707.708L7.293 8l-3.647 3.646.708.707L8 8.707z", fill: "currentColor" }) }));
const DismissibleUpsell = memo(({ upsellId, className, icon, children, variant = "default", onDismiss, onClick, dismissOnClick = false, }) => {
    ...
    const variants = {
        banner: {
            container: "p-2 bg-vscode-badge-background/80 text-vscode-badge-foreground border-vscode-dropdown-border border",
    ...
    return (_jsxs("div", { className: containerClasses, onClick: () => {
        ...
        }, children: [icon && icon, _jsx("div", { children: children }), _jsx("button", { className: buttonClasses, onClick: (e) => {
                    e.stopPropagation(); // Prevent triggering the container's onClick
                    handleDismiss();
                }, "aria-label": t("common:dismiss"), title: t("common:dismissAndDontShowAgain"), children: _jsx(DismissIcon, {}) })] }));
});
