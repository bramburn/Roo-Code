		...
		children: [
			_jsx(SectionHeader, {
				children: _jsxs("div", {
					...
					children: [
						_jsx(SquareSlash, { className: "w-4" }),
						_jsx("div", { children: t("settings:sections.slashCommands") }),
					],
				}),
			}),
			_jsxs(Section, {
					...
					_jsxs("div", {
						...
						children: [
							_jsxs("div", {
								...
								children: [
									_jsx(Globe, { className: "w-3 h-3" }),
									_jsx("h4", {
										className: "text-sm font-medium m-0",
										children: t("chat:slashCommands.globalCommands"),
									}),
								],
							}),
							_jsxs("div", {
								className: "border border-vscode-panel-border rounded-md",
								children: [
									...
									_jsxs("div", {
										className:
											"px-4 py-2 flex items-center gap-2 hover:bg-vscode-list-hoverBackground border-t border-vscode-panel-border",
										children: [
											_jsx("input", {
												type: "text",
												value: globalNewName,
												...
												className:
													"flex-1 bg-vscode-input-background text-vscode-input-foreground placeholder-vscode-input-placeholderForeground border border-vscode-input-border rounded px-2 py-1 text-sm focus:outline-none focus:border-vscode-focusBorder",
												onKeyDown: (e) => {
													if (e.key === "Enter") {
											...
											_jsx(Button, {
												...
												className:
													"size-6 flex items-center justify-center opacity-60 hover:opacity-100",
						...
						_jsxs("div", {
							...
							children: [
								_jsxs("div", {
									className: "flex items-center gap-1.5 mb-2",
									children: [
										_jsx(Folder, { className: "w-3 h-3" }),
										_jsx("h4", {
											className: "text-sm font-medium m-0",
											children: t("chat:slashCommands.workspaceCommands"),
										}),
									],
								}),
								_jsxs("div", {
							...
							children: [
								_jsxs("div", {
									...
									children: [
										...
										_jsx("h4", {
											className: "text-sm font-medium m-0",
											children: t("chat:slashCommands.builtInCommands"),
										}),
									],
								}),
								_jsx("div", {
									className: "border border-vscode-panel-border rounded-md",
									children: builtInCommands.map((command) =>
										_jsx(
											SlashCommandItem,
											{
												command: command,
				...
				children: _jsxs(AlertDialogContent, {
					children: [
						_jsxs(AlertDialogHeader, {
							children: [
								_jsx(AlertDialogTitle, { children: t("chat:slashCommands.deleteDialog.title") }),
								_jsx(AlertDialogDescription, {
									children: t("chat:slashCommands.deleteDialog.description", {
						...
						_jsxs(AlertDialogFooter, {
							children: [
								_jsx(AlertDialogCancel, {
									...
									children: t("chat:slashCommands.deleteDialog.cancel"),
								}),
								_jsx(AlertDialogAction, {
									onClick: handleDeleteConfirm,
									children: t("chat:slashCommands.deleteDialog.confirm"),
								}),
							],
						}),
					],
