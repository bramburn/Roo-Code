...
export const SimpleThinkingBudget = ({ apiConfiguration, setApiConfigurationField, modelInfo, }) => {
    ...
    const availableReasoningEfforts = isReasoningEffortRequired
        ? baseEfforts
        : ["none", ...baseEfforts];
    ...
    const defaultReasoningEffort = isReasoningEffortRequired
    ...
    return (_jsxs("div", { className: "flex flex-col gap-1", "data-testid": "simple-reasoning-effort", children: [_jsx("div", { className: "flex justify-between items-center", children: _jsx("label", { className: "block font-medium mb-1", children: t("settings:providers.reasoningEffort.label") }) }), _jsxs(Select, { value: currentReasoningEffort, onValueChange: (value) => {
                    ...
                    if (value === "none") {
                        ...
                        setApiConfigurationField("reasoningEffort", value);
                                ...
                                : t("settings:common.select") }) }), _jsx(SelectContent, { children: availableReasoningEfforts.map((value) => (_jsx(SelectItem, { value: value, children: value === "none"
                                ? t("settings:providers.reasoningEffort.none")
                                : t(`settings:providers.reasoningEffort.${value}`) }, value))) })] })] }));
};
