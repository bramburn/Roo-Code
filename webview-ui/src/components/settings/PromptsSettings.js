		...
		children: [
			_jsx(SectionHeader, {
				...
				children: _jsxs("div", {
					...
					children: [
						_jsx(MessageSquare, { className: "w-4" }),
						_jsx("div", { children: t("settings:sections.prompts") }),
					],
				}),
			}),
			_jsxs(Section, {
					...
					_jsxs("div", {
						children: [
							_jsxs(Select, {
								...
								onValueChange: (type) => setActiveSupportOption(type),
								children: [
									_jsx(SelectTrigger, {
										className: "w-full",
									...
									_jsx(SelectContent, {
										children: Object.keys(supportPrompt.default).map((type) =>
											_jsx(
												SelectItem,
												{
													value: type,
													"data-testid": `${type}-option`,
													children: t(`prompts:supportPrompts.types.${type}.label`),
												},
												type,
											),
										),
							...
							_jsx("div", {
								...
								children: t(`prompts:supportPrompts.types.${activeSupportOption}.description`),
							}),
						],
					}),
					_jsxs(
						"div",
						{
							...
							children: [
								_jsxs("div", {
									...
									children: [
										_jsx("label", {
											...
											children: t("prompts:supportPrompts.prompt"),
										}),
								...
								(activeSupportOption === "ENHANCE" || activeSupportOption === "CONDENSE") &&
									_jsxs("div", {
										className:
											"mt-4 flex flex-col gap-3 pl-3 border-l-2 border-vscode-button-background",
										children: [
											_jsxs("div", {
												children: [
													_jsx("label", {
															...
															_jsx(SelectTrigger, {
																...
																children: _jsx(SelectValue, {
																	placeholder:
																		activeSupportOption === "ENHANCE"
																			? t(
																					"prompts:supportPrompts.enhance.useCurrentConfig",
																				)
																			: t(
													...
													children: [
														_jsxs("div", {
															children: [
																...
																_jsx("div", {
																	className:
																		"text-vscode-descriptionForeground text-sm mt-1 mb-3",
																	children: t(
														...
														_jsxs("div", {
															children: [
																_jsx("label", {
																	className: "block font-medium mb-1",
																	children: t(
																		"prompts:supportPrompts.enhance.testEnhancement",
																	),
																}),
																_jsx(VSCodeTextArea, {
																	resize: "vertical",
																...
																_jsx("div", {
																	className:
																		"mt-2 flex justify-start items-center gap-2",
																	children: _jsx(Button, {
																		variant: "default",
																		onClick: handleTestEnhancement,
																		disabled: isEnhancing,
																		children: t(
																			"prompts:supportPrompts.enhance.previewButton",
																		),
																	}),
																}),
															],
