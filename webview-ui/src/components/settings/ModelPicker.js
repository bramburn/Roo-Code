...
export const ModelPicker = ({
	...
	return _jsxs(_Fragment, {
		children: [
			_jsxs("div", {
				children: [
					_jsx("label", { className: "block font-medium mb-1", children: t("settings:modelPicker.label") }),
					_jsxs(Popover, {
						open: open,
							...
							_jsx(PopoverTrigger, {
								...
								children: _jsxs(Button, {
									...
									children: [
										_jsx("div", {
											className: "truncate",
											children: selectedModelId ?? t("settings:common.select"),
										}),
										_jsx(ChevronsUpDown, { className: "opacity-50" }),
									],
								}),
							}),
							_jsx(PopoverContent, {
								...
								children: _jsxs(Command, {
									children: [
												...
												_jsx(CommandEmpty, {
													children:
														...
														_jsx("div", {
															...
															children: t("settings:modelPicker.noMatchFound"),
														}),
												}),
												_jsx(CommandGroup, {
													children: modelIds.map((model) =>
														_jsxs(
															CommandItem,
															{
																value: model,
										...
										searchValue &&
											!modelIds.includes(searchValue) &&
											_jsx("div", {
												className: "p-1 border-t border-vscode-input-border",
												children: _jsx(CommandItem, {
													"data-testid": "use-custom-model",
													value: searchValue,
													onSelect: onSelect,
													children: t("settings:modelPicker.useCustomModel", {
														modelId: searchValue,
													}),
												}),
											}),
			...
			_jsx("div", {
				...
				children: _jsx(Trans, {
					...
					components: {
						...
						defaultModelLink: _jsx(VSCodeLink, {
							onClick: () => onSelect(defaultModelId),
							className: "text-sm",
						}),
					},
