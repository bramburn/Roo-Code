	...
	return _jsxs(_Fragment, {
		children: [
				...
				children: _jsxs("div", {
					...
					children: [
						_jsx("label", {
							...
							children: t("settings:providers.requestyApiKey"),
						}),
						apiConfiguration?.requestyApiKey &&
							_jsx(RequestyBalanceDisplay, {
			...
			_jsx("a", {
				...
				className:
					"inline-flex items-center justify-center whitespace-nowrap text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground shadow hover:bg-primary/90 h-9 rounded-md px-3 w-full",
				style: {
					width: "100%",
					textDecoration: "none",
				...
				children: t("settings:providers.getRequestyApiKey"),
			}),
			_jsx(VSCodeCheckbox, {
				...
				children: t("settings:providers.requestyUseCustomBaseUrl"),
			}),
			requestyEndpointSelected &&
				_jsx(VSCodeTextField, {
					...
					children: _jsx("div", {
						...
						children: _jsx("label", {
							className: "block font-medium",
							children: t("settings:providers.getRequestyBaseUrl"),
						}),
					}),
				}),
			_jsx(Button, {
