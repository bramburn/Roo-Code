			...
			_jsxs("div", {
				children: [
					_jsx("label", {
						...
						children: t("settings:providers.minimaxBaseUrl"),
					}),
					_jsxs(VSCodeDropdown, {
						...
						children: [
							_jsx(VSCodeOption, {
								...
								className: "p-2",
								children: "api.minimax.io",
							}),
							_jsx(VSCodeOption, {
								value: "https://api.minimaxi.com/v1",
								className: "p-2",
								children: "api.minimaxi.com",
							}),
						],
					}),
				],
			...
			_jsxs("div", {
				children: [
					_jsx(VSCodeTextField, {
						...
						children: _jsx("label", {
							className: "block font-medium mb-1",
							children: t("settings:providers.minimaxApiKey"),
						}),
					}),
					_jsx("div", {
					...
					!apiConfiguration?.minimaxApiKey &&
						_jsx(VSCodeButtonLink, {
							...
							children: t("settings:providers.getMiniMaxApiKey"),
						}),
				],
			}),
		],
