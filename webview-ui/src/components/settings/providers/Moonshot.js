			...
			_jsxs("div", {
				children: [
					_jsx("label", {
						...
						children: t("settings:providers.moonshotBaseUrl"),
					}),
					_jsxs(VSCodeDropdown, {
						...
						children: [
							_jsx(VSCodeOption, {
								...
								className: "p-2",
								children: "api.moonshot.ai",
							}),
							_jsx(VSCodeOption, {
								value: "https://api.moonshot.cn/v1",
								className: "p-2",
								children: "api.moonshot.cn",
							}),
						],
					}),
				],
			...
			_jsxs("div", {
				children: [
					_jsx(VSCodeTextField, {
						...
						children: _jsx("label", {
							className: "block font-medium mb-1",
							children: t("settings:providers.moonshotApiKey"),
						}),
					}),
					_jsx("div", {
					...
					!apiConfiguration?.moonshotApiKey &&
						_jsx(VSCodeButtonLink, {
							...
							children: t("settings:providers.getMoonshotApiKey"),
						}),
				],
			}),
		],
