			...
			_jsxs("div", {
				children: [
						...
						children: zaiApiLineSchema.options.map((zaiApiLine) => {
							...
							return _jsxs(
								VSCodeOption,
								{
									value: zaiApiLine,
									className: "p-2",
									children: [config.name, " (", config.baseUrl, ")"],
								},
								zaiApiLine,
							)
						}),
					...
					_jsx("div", {
						...
						children: t("settings:providers.zaiEntrypointDescription"),
					}),
				],
			}),
			_jsxs("div", {
				children: [
					_jsx(VSCodeTextField, {
						...
						children: _jsx("label", {
							className: "block font-medium mb-1",
							children: t("settings:providers.zaiApiKey"),
						}),
					}),
					_jsx("div", {
					...
					!apiConfiguration?.zaiApiKey &&
						_jsx(VSCodeButtonLink, {
							href: zaiApiLineConfigs[apiConfiguration.zaiApiLine ?? "international_coding"].isChina
								? "https://open.bigmodel.cn/console/overview"
								: "https://z.ai/manage-apikey/apikey-list",
							appearance: "secondary",
							children: t("settings:providers.getZaiApiKey"),
						}),
				],
			}),
		],
