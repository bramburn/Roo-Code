		...
		children: [
			_jsx(VSCodeTextField, {
				...
				children: _jsx("label", {
					...
					children: t("settings:providers.anthropicApiKey"),
				}),
			}),
			_jsx("div", {
			...
			!apiConfiguration?.apiKey &&
				_jsx(VSCodeButtonLink, {
					...
					children: t("settings:providers.getAnthropicApiKey"),
				}),
			_jsxs("div", {
				children: [
					_jsx(Checkbox, {
						...
						_jsxs(_Fragment, {
							children: [
								...
								_jsx(Checkbox, {
									...
									className: "w-full mt-1",
									children: t("settings:providers.anthropicUseAuthToken"),
								}),
							],
						}),
				],
				...
				_jsxs("div", {
					children: [
						_jsx(Checkbox, {
							...
							children: t("settings:providers.anthropic1MContextBetaLabel"),
						}),
						_jsx("div", {
							className: "text-sm text-vscode-descriptionForeground mt-1 ml-6",
							children: t("settings:providers.anthropic1MContextBetaDescription"),
						}),
					],
				}),
		],
