	...
	return _jsxs(_Fragment, {
		children: [
			_jsx(VSCodeTextField, {
				...
				className: "w-full",
				children: _jsx("span", { className: "font-medium", children: t("settings:providers.mistralApiKey") }),
			}),
			_jsx("div", {
			...
			!apiConfiguration?.mistralApiKey &&
				_jsx(VSCodeButtonLink, {
					...
					children: t("settings:providers.getMistralApiKey"),
				}),
					...
					children: [
						_jsx(VSCodeTextField, {
							...
							children: _jsx("label", {
								...
								children: t("settings:providers.codestralBaseUrl"),
							}),
						}),
						_jsx("div", {
							className: "text-sm text-vscode-descriptionForeground -mt-2",
							children: t("settings:providers.codestralBaseUrlDesc"),
						}),
					],
				}),
		],
