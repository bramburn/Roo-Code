	...
	return _jsxs(_Fragment, {
		children: [
			_jsx(Checkbox, {
				...
				children: t("settings:providers.useCustomBaseUrl"),
			}),
			...
			_jsx(VSCodeTextField, {
				...
				children: _jsx("label", {
					...
					children: t("settings:providers.openAiApiKey"),
				}),
			}),
			_jsx("div", {
			...
			!apiConfiguration?.openAiNativeApiKey &&
				_jsx(VSCodeButtonLink, {
					...
					children: t("settings:providers.getOpenAiApiKey"),
				}),
			(() => {
				...
				return _jsxs("div", {
					...
					children: [
						_jsxs("div", {
							...
							children: [
								_jsx("label", { className: "block font-medium mb-1", children: "Service tier" }),
						...
						_jsxs(Select, {
							...
							onValueChange: (value) => setApiConfigurationField("openAiNativeServiceTier", value),
							children: [
								_jsx(SelectTrigger, {
									className: "w-full",
								...
								_jsxs(SelectContent, {
									children: [
										_jsx(SelectItem, { value: "default", children: "Standard" }),
										allowedTiers.includes("flex") &&
											_jsx(SelectItem, { value: "flex", children: "Flex" }),
										allowedTiers.includes("priority") &&
											_jsx(SelectItem, { value: "priority", children: "Priority" }),
									],
								}),
							],
						}),
