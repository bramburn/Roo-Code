		...
		children: _jsxs("div", {
			children: [
				_jsx(VSCodeTextField, {
					...
					children: "OAuth Credentials Path",
				}),
				_jsx("p", {
					className: "text-xs mt-1 text-vscode-descriptionForeground",
					children:
						"Path to your Qwen OAuth credentials file. Defaults to ~/.qwen/oauth_creds.json if left empty.",
				}),
				_jsx("div", {
					className: "text-xs text-vscode-descriptionForeground mt-3",
					children:
				...
				_jsxs("div", {
					className: "text-xs text-vscode-descriptionForeground mt-2",
					children: [
						"To get started:",
						_jsx("br", {}),
