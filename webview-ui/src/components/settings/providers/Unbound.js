...
export const Unbound = ({ apiConfiguration, setApiConfigurationField, routerModels, organizationAllowList, modelValidationError, }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(VSCodeTextField, { value: apiConfiguration?.unboundApiKey || "", type: "password", onInput: handleInputChange("unboundApiKey"), placeholder: t("settings:placeholders.apiKey"), className: "w-full", children: _jsx("label", { className: "block font-medium mb-1", children: t("settings:providers.unboundApiKey") }) }), _jsx("div", { className: "text-sm text-vscode-descriptionForeground -mt-2", children: t("settings:providers.apiKeyStorageNotice") }), !apiConfiguration?.unboundApiKey && (_jsx(VSCodeButtonLink, { href: "https://gateway.getunbound.ai", appearance: "secondary", children: t("settings:providers.getUnboundApiKey") })), _jsx("div", { className: "flex justify-end", children: _jsx(Button, { variant: "outline", onClick: handleRefresh, className: "w-1/2 max-w-xs", children: _jsxs("div", { className: "flex items-center gap-2 justify-center", children: [_jsx("span", { className: "codicon codicon-refresh" }), t("settings:providers.refreshModels.label")] }) }) }), didRefetch && (_jsx("div", { className: "flex items-center text-vscode-charts-green", children: t("settings:providers.unboundRefreshModelsSuccess") })), isInvalidKey && (_jsx("div", { className: "flex items-center text-vscode-errorForeground", children: t("settings:providers.unboundInvalidApiKey") })), _jsx(ModelPicker, { apiConfiguration: apiConfiguration, defaultModelId: unboundDefaultModelId, models: routerModels?.unbound ?? {}, modelIdKey: "unboundModelId", serviceName: "Unbound", serviceUrl: "https://api.getunbound.ai/models", setApiConfigurationField: setApiConfigurationField, organizationAllowList: organizationAllowList, errorMessage: modelValidationError })] }));
};
