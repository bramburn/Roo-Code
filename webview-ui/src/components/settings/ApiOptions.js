...
const ApiOptions = ({
	...
	return _jsxs("div", {
		...
		children: [
					...
					_jsxs("div", {
						...
						children: [
							_jsx("label", {
								...
								children: t("settings:providers.apiProvider"),
							}),
							docs &&
								_jsx("div", {
									...
									children: _jsx(VSCodeLink, {
										...
										target: "_blank",
										children: t("settings:providers.providerDocumentation", {
											provider: docs.name,
										}),
									}),
								}),
			...
			errorMessage && _jsx(ApiErrorMessage, { errorMessage: errorMessage }),
			...
			selectedProvider === "xai" &&
				_jsx(XAI, { apiConfiguration: apiConfiguration, setApiConfigurationField: setApiConfigurationField }),
			selectedProvider === "groq" &&
				_jsx(Groq, { apiConfiguration: apiConfiguration, setApiConfigurationField: setApiConfigurationField }),
			...
			selectedProvider === "zai" &&
				_jsx(ZAi, { apiConfiguration: apiConfiguration, setApiConfigurationField: setApiConfigurationField }),
				...
				_jsxs(_Fragment, {
					children: [
						_jsx("div", {
							...
							children: t("settings:providers.humanRelay.description"),
						}),
						_jsx("div", {
							className: "text-sm text-vscode-descriptionForeground",
					...
					children: [
						_jsxs("div", {
							children: [
								_jsx("label", {
									className: "block font-medium mb-1",
									children: t("settings:providers.model"),
								}),
								_jsxs(Select, {
										...
										_jsxs(SelectContent, {
											children: [
												...
												selectedProvider === "bedrock" &&
													_jsx(SelectItem, {
														value: "custom-arn",
														children: t("settings:labels.useCustomArn"),
													}),
											],
										}),
									],
						...
						selectedModelInfo?.deprecated &&
							_jsx(ApiErrorMessage, { errorMessage: t("settings:validation.modelDeprecated") }),
						selectedProvider === "bedrock" &&
							selectedModelId === "custom-arn" &&
							_jsx(BedrockCustomArn, {
								apiConfiguration: apiConfiguration,
								setApiConfigurationField: setApiConfigurationField,
							}),
						!selectedModelInfo?.deprecated &&
				...
				_jsxs(Collapsible, {
					...
					children: [
						_jsxs(CollapsibleTrigger, {
							className: "flex items-center gap-1 w-full cursor-pointer hover:opacity-80 mb-2",
							children: [
								_jsx("span", {
								...
								_jsx("span", {
									...
									children: t("settings:advancedSettings.title"),
								}),
							],
						}),
						_jsxs(CollapsibleContent, {
							className: "space-y-3",
							children: [
								_jsx(TodoListSettingsControl, {
									todoListEnabled: apiConfiguration.todoListEnabled,
									onChange: (field, value) => setApiConfigurationField(field, value),
								}),
								_jsx(DiffSettingsControl, {
									diffEnabled: apiConfiguration.diffEnabled,
									fuzzyMatchThreshold: apiConfiguration.fuzzyMatchThreshold,
									onChange: (field, value) => setApiConfigurationField(field, value),
								}),
								selectedModelInfo?.supportsTemperature !== false &&
									_jsx(TemperatureControl, {
										value: apiConfiguration.modelTemperature,
										onChange: handleInputChange("modelTemperature", noTransform),
										maxValue: 2,
									}),
								_jsx(RateLimitSecondsControl, {
									value: apiConfiguration.rateLimitSeconds || 0,
									onChange: (value) => setApiConfigurationField("rateLimitSeconds", value),
								}),
								_jsx(ConsecutiveMistakeLimitControl, {
									value:
											...
											_jsxs("div", {
												...
												children: [
													_jsx("label", {
														className: "block font-medium mb-1",
														children: t(
															"settings:providers.openRouter.providerRouting.title",
														),
													}),
													_jsx("a", {
														href: `https://openrouter.ai/${selectedModelId}/providers`,
														children: _jsx(ExternalLinkIcon, { className: "w-4 h-4" }),
													}),
												],
											}),
											_jsxs(Select, {
													...
													_jsxs(SelectContent, {
														children: [
															_jsx(SelectItem, {
																...
																children: OPENROUTER_DEFAULT_PROVIDER_NAME,
															}),
											...
											_jsxs("div", {
												...
												children: [
													...
													_jsxs("a", {
														...
														children: [
															t(
																"settings:providers.openRouter.providerRouting.learnMore",
															),
															".",
														],
													}),
