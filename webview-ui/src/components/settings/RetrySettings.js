...
export const RetrySettingsPanel = ({ settings, onSettingsChange, className = "" }) => {
	...
	const SettingField = ({ label, value, onChange, type = "number", min, max, step = 1, options, tooltip, icon }) =>
		_jsxs("div", {
			...
			children: [
				_jsxs("div", {
					...
					children: [
						icon && _jsx("span", { className: "w-4 h-4 text-gray-500", children: icon }),
						_jsx("label", {
						...
						tooltip &&
							_jsxs("div", {
								...
								children: [
									_jsx(Info, { className: "w-3 h-3 text-gray-400 cursor-help" }),
									_jsx("div", {
										className:
											"absolute left-0 top-5 z-10 hidden w-64 p-2 text-xs bg-gray-900 text-white rounded shadow-lg group-hover:block",
										children: tooltip,
									}),
								],
							}),
				...
				type === "number" &&
					_jsx("input", {
						...
						step: step,
						className:
							"px-3 py-1 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",
					}),
				type === "select" &&
					options &&
					_jsx("select", {
	...
	return _jsxs("div", {
		...
		children: [
			_jsxs("div", {
				...
				children: [
					_jsx(Settings, { className: "w-5 h-5 text-gray-600 dark:text-gray-400" }),
					_jsx("h2", {
					...
					_jsxs("div", {
						...
						children: [
							...
							_jsx(SettingField, {
								...
								icon: _jsx(RotateCcw, { className: "w-4 h-4" }),
							}),
							_jsx(SettingField, {
			...
			_jsxs("div", {
				...
				children: [
					_jsx("button", {
						...
						className:
							"px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors",
					...
					_jsx("button", {
						...
						className:
							"px-4 py-2 text-sm font-medium text-blue-700 dark:text-blue-300 bg-blue-100 dark:bg-blue-900 rounded-md hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors",
...
//# sourceMappingURL=RetrySettings.js.map
