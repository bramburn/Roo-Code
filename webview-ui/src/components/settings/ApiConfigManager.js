...
const ApiConfigManager = ({
	...
	return _jsxs("div", {
		...
		children: [
			_jsx("label", { className: "block font-medium mb-1", children: t("settings:providers.configProfile") }),
			isRenaming
				? _jsxs("div", {
							...
							_jsxs("div", {
								...
								children: [
									...
									_jsx(StandardTooltip, {
										content: t("settings:common.save"),
										children: _jsx(Button, {
											...
											children: _jsx("span", { className: "codicon codicon-check" }),
										}),
									}),
									_jsx(StandardTooltip, {
										content: t("settings:common.cancel"),
										children: _jsx(Button, {
											variant: "ghost",
											size: "icon",
						...
						children: [
							_jsxs("div", {
								...
								children: [
									...
									_jsx(StandardTooltip, {
										content: t("settings:providers.addProfile"),
										children: _jsx(Button, {
											variant: "ghost",
											size: "icon",
											onClick: handleAdd,
											...
											children: [
												_jsx(StandardTooltip, {
													...
													children: _jsx(Button, {
														...
														children: _jsx("span", { className: "codicon codicon-edit" }),
													}),
												}),
												_jsx(StandardTooltip, {
													content: isOnlyProfile
							...
							_jsx("div", {
								className: "text-vscode-descriptionForeground text-sm mt-1",
								children: t("settings:providers.description"),
							}),
						],
					}),
			_jsx(Dialog, {
				...
				children: _jsxs(DialogContent, {
					className: "p-4 max-w-sm bg-card",
					children: [
						_jsx(DialogTitle, { children: t("settings:providers.newProfile") }),
						_jsx(Input, {
						...
						_jsxs("div", {
							...
							children: [
								_jsx(Button, {
									...
									children: t("settings:common.cancel"),
								}),
								_jsx(Button, {
									variant: "default",
									...
									children: t("settings:providers.createProfile"),
								}),
							],
						}),
					],
