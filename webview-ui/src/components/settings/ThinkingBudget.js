...
export const ThinkingBudget = ({ apiConfiguration, setApiConfigurationField, modelInfo }) => {
	...
	const availableReasoningEfforts = showMinimalOption ? ["minimal", ...baseEfforts] : baseEfforts
	...
	if (isReasoningSupported) {
		return _jsx("div", {
			...
			children: _jsx(Checkbox, {
				...
				onChange: (checked) => setApiConfigurationField("enableReasoningEffort", checked === true),
				children: t("settings:providers.useReasoning"),
			}),
		})
	}
							...
							children: [
								_jsxs("div", {
									...
									children: [
										_jsx("div", {
											...
											children: t("settings:thinkingBudget.maxTokens"),
										}),
										_jsxs("div", {
											...
											children: [
												...
												_jsx("div", {
													...
													children: customMaxOutputTokens,
												}),
											],
										}),
									],
								...
								_jsxs("div", {
									...
									children: [
										_jsx("div", {
											className: "font-medium",
											children: t("settings:thinkingBudget.maxThinkingTokens"),
										}),
										_jsxs("div", {
											className: "flex items-center gap-1",
											...
											children: [
												...
												_jsx("div", {
													className: "w-12 text-sm text-center",
													children: customMaxThinkingTokens,
												}),
											],
										}),
									],
								...
								_jsx(SelectContent, {
									children: availableReasoningEfforts.map((value) =>
										_jsx(
											...
											{
												value: value,
												children: t(`settings:providers.reasoningEffort.${value}`),
											},
											value,
										),
									),
