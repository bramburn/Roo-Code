	...
	return _jsxs("div", {
		...
		children: [
			_jsx("label", {
				...
				children: t("settings:providers.consecutiveMistakeLimit.label"),
			}),
			_jsxs("div", {
				...
				children: [
					...
					_jsx("span", {
						className: "w-10",
						children: Math.max(0, value ?? DEFAULT_CONSECUTIVE_MISTAKE_LIMIT),
					}),
				],
			}),
			_jsx("div", {
			...
			value === 0 &&
				_jsx("div", {
					...
					children: t("settings:providers.consecutiveMistakeLimit.warning"),
				}),
		],
	})
}
