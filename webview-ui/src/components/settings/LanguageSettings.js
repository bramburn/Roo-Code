		...
		children: [
			_jsx(SectionHeader, {
				children: _jsxs("div", {
					...
					children: [
						_jsx(Globe, { className: "w-4" }),
						_jsx("div", { children: t("settings:sections.language") }),
					],
				}),
			}),
			_jsx(Section, {
				children: _jsxs(Select, {
					value: language,
					onValueChange: (value) => setCachedStateField("language", value),
					children: [
						_jsx(SelectTrigger, {
							className: "w-full",
						...
						_jsx(SelectContent, {
							children: _jsx(SelectGroup, {
								children: Object.entries(LANGUAGES).map(([code, name]) =>
									_jsxs(
										SelectItem,
										{
											value: code,
