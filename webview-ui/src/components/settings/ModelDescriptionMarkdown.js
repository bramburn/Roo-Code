	...
	return _jsxs(Collapsible, {
		...
		children: [
			_jsx("div", {
				...
				className: cn({ "line-clamp-4": !isExpanded }),
				children: _jsx("div", { ref: textRef, children: _jsx(StyledMarkdown, { children: content }, key) }),
			}),
			_jsx(CollapsibleTrigger, {
				asChild: true,
				className: cn({ hidden: !isExpandable }),
				children: _jsx(VSCodeLink, { className: "text-sm", children: isExpanded ? "Less" : "More" }),
			}),
		],
	})
})
