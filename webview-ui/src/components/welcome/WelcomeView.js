	...
	return _jsxs(Tab, {
		children: [
			_jsxs(TabContent, {
				...
				children: [
					_jsx(RooHero, {}),
					_jsx("h2", { className: "mt-0 mb-4 text-xl text-center", children: t("welcome:greeting") }),
					_jsxs("div", {
						className: "text-base text-vscode-foreground py-2 px-2 mb-4",
						children: [
							_jsx("p", {
								className: "mb-3 leading-relaxed",
								children: _jsx(Trans, { i18nKey: "welcome:introduction" }),
							}),
							_jsx("p", {
								className: "mb-0 leading-relaxed",
								children: _jsx(Trans, { i18nKey: "welcome:chooseProvider" }),
							}),
						],
					}),
					_jsxs("div", {
						...
						children: [
							_jsx("p", {
								className: "text-sm font-medium mt-4 mb-3",
								children: t("welcome:startRouter"),
							}),
							_jsx("div", {
								children: (() => {
									...
									return orderedProviders.map((provider, index) =>
										_jsxs(
											"a",
											{
												...
												className:
													"relative flex-1 border border-vscode-panel-border hover:bg-secondary rounded-md py-3 px-4 mb-2 flex flex-row gap-3 cursor-pointer transition-all no-underline text-inherit",
												target: "_blank",
												...
												children: [
													provider.incentive &&
														_jsx("div", {
															className:
																"absolute top-0 right-0 text-[10px] text-vscode-badge-foreground bg-vscode-badge-background px-2 py-0.5 rounded-bl rounded-tr-md",
							...
							_jsx("p", {
								className: "text-sm font-medium mt-6 mb-3",
								children: t("welcome:startCustom"),
							}),
							_jsx(ApiOptions, {
			...
			_jsx("div", {
				className: "sticky bottom-0 bg-vscode-sideBar-background p-4 border-t border-vscode-panel-border",
				children: _jsxs("div", {
					...
					children: [
						_jsx("div", {
							...
							children: _jsx(VSCodeLink, {
								...
								className: "text-sm",
								children: t("welcome:importSettings"),
							}),
						}),
						_jsx(VSCodeButton, {
						...
						errorMessage &&
							_jsx("div", { className: "text-vscode-errorForeground", children: errorMessage }),
					],
				}),
			}),
		],
