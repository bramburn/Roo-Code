		...
		children: [
				...
				children: _jsxs(PopoverTrigger, {
					...
					children: [
						!effectiveAutoApprovalEnabled
							? _jsx(X, { className: "size-3 flex-shrink-0" })
							: _jsx(CheckCheck, { className: "size-3 flex-shrink-0" }),
						_jsx("span", {
							className: "hidden min-[300px]:inline truncate min-w-0",
							children: !effectiveAutoApprovalEnabled
						...
						_jsx("span", {
							className: "inline min-[300px]:hidden min-w-0",
							children: !effectiveAutoApprovalEnabled
			...
			_jsx(PopoverContent, {
				...
				children: _jsxs("div", {
					...
					children: [
						_jsxs("div", {
							className: "p-3 border-b border-vscode-dropdown-border",
							children: [
								_jsxs("div", {
									className: "flex items-center justify-between gap-1 pr-1 pb-2",
									children: [
										_jsx("h4", {
											className: "m-0 font-bold text-base text-vscode-foreground",
											children: t("chat:autoApprove.title"),
										}),
										_jsx(Settings, {
								...
								_jsx("p", {
									className: "m-0 text-xs text-vscode-descriptionForeground",
									children: t("chat:autoApprove.description"),
								}),
							],
						}),
						_jsx("div", {
							className: "grid grid-cols-1 min-[340px]:grid-cols-2 gap-x-2 gap-y-2 p-3",
							children: settingsArray.map(({ key, labelKey, descriptionKey, icon }) => {
									...
									StandardTooltip,
									{
										...
										children: _jsxs("button", {
											...
											children: [
												...
												_jsx("span", { className: "flex-1 truncate", children: t(labelKey) }),
											],
										}),
									},
									key,
						...
						_jsxs("div", {
							className:
								"flex flex-row items-center justify-between px-2 py-2 border-t border-vscode-dropdown-border",
							children: [
								_jsxs("div", {
									...
									children: [
										_jsxs("button", {
											...
											children: [
												_jsx(ListChecks, { className: "w-3.5 h-3.5" }),
												_jsx("span", { children: t("chat:autoApprove.all") }),
											],
										}),
										_jsxs("button", {
											...
											children: [
												_jsx(LayoutList, { className: "w-3.5 h-3.5" }),
												_jsx("span", { children: t("chat:autoApprove.none") }),
											],
										}),
									],
								}),
								_jsxs("label", {
									...
									children: [
										...
										_jsx("span", {
											className: cn("text-sm font-bold select-none"),
											children: "Enabled",
										}),
									],
								}),
