...
export const AutoApprovedRequestLimitWarning = memo(({ message }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px", color: "var(--vscode-foreground)" }, children: [_jsx("span", { className: "codicon codicon-warning" }), _jsx("span", { style: { fontWeight: "bold" }, children: _jsx(Trans, { i18nKey: titleKey, ns: "chat" }) })] }), _jsxs("div", { className: "bg-vscode-panel-border flex flex-col gap-3", style: {
                    borderRadius: "4px",
                    display: "flex",
                    marginTop: "15px",
                    padding: "14px 16px 22px",
                    justifyContent: "center",
                }, children: [_jsx("div", { className: "flex justify-between items-center", children: _jsx(Trans, { i18nKey: descriptionKey, ns: "chat", values: { count } }) }), _jsx(VSCodeButton, { style: { width: "100%", padding: "6px", borderRadius: "4px" }, onClick: (e) => {
                            e.preventDefault();
