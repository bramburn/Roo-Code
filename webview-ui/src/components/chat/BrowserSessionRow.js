...
const BrowserSessionRow = memo((props) => {
			...
			children: [
				currentPage?.nextAction?.messages.map((message) =>
					_jsx(
						...
						{ ...props, message: message, setMaxActionHeight: setMaxActionHeight },
						message.ts,
					),
				),
				!isBrowsing &&
	...
	const [browserSessionRow, { height: rowHeight }] = useSize(
		_jsxs("div", {
			style: { padding: "10px 6px 10px 15px", marginBottom: -10 },
			children: [
				_jsxs("div", {
					...
					children: [
						isBrowsing
							...
							: _jsx(Pointer, { className: "w-4", "aria-label": "Browser action indicator" }),
						_jsx("span", {
							style: { fontWeight: "bold" },
							children: _jsx(_Fragment, { children: t("chat:browser.rooWantsToUse") }),
						}),
					],
				}),
				_jsxs("div", {
					...
					children: [
						_jsx("div", {
							...
							children: _jsxs("div", {
								...
								children: [
									_jsx(Globe, { className: "w-3 inline -mt-0.5 mr-2 opacity-50" }),
						...
						_jsxs("div", {
							...
							className:
								"flex items-center justify-between gap-2 text-vscode-editor-foreground/50 hover:text-vscode-editor-foreground transition-colors",
							style: {
								width: "100%",
								cursor: "pointer",
							...
							children: [
								_jsx(SquareTerminal, { className: "w-3" }),
								_jsx("span", { className: "grow text-xs", children: t("chat:browser.consoleLogs") }),
								_jsx("span", {
				...
				_jsx("div", { style: { minHeight: maxActionHeight }, children: actionContent }),
				pages.length > 1 &&
					_jsxs("div", {
						style: {
							display: "flex",
						...
						children: [
							_jsx("div", {
								children: t("chat:browser.navigation.step", {
							...
							_jsxs("div", {
								...
								children: [
									_jsx(VSCodeButton, {
										...
										children: t("chat:browser.navigation.previous"),
									}),
									_jsx(VSCodeButton, {
										disabled: currentPageIndex === pages.length - 1 || isBrowsing,
										onClick: () => setCurrentPageIndex((i) => i + 1),
										children: t("chat:browser.navigation.next"),
									}),
								],
							}),
						],
					...
					return _jsxs(_Fragment, {
						children: [
							_jsx("div", {
								...
								children: _jsx("span", {
									style: { fontWeight: "bold" },
									children: t("chat:browser.sessionStarted"),
								}),
							}),
							_jsx("div", {
								style: {
		...
		children: _jsx("div", {
			...
			children: _jsx("div", {
				...
				children: _jsxs("span", {
					...
					children: [
						_jsx("span", { style: { fontWeight: 500 }, children: t("chat:browser.actions.title") }),
