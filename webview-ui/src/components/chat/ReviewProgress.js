	...
	if (!status) {
		return _jsx("div", {
			...
			children: _jsx("div", {
				...
				children: "Loading review progress...",
			}),
		})
	}
	return _jsxs("div", {
		...
		children: [
			_jsx("div", {
				className: `w-16 h-16 rounded-full flex items-center justify-center mb-4 ${statusInfo.bgColor}`,
				children: _jsx("div", { className: "text-2xl", children: statusInfo.icon }),
			}),
			_jsx("div", { className: `text-lg font-medium mb-4 ${statusInfo.color}`, children: getStatusText() }),
					...
					children: [
						_jsxs("div", {
							...
							children: [
								_jsx("div", {
									...
									children: _jsx("div", {
										className:
											"bg-gradient-to-r from-vscode-progress-foreground to-vscode-progress-foreground h-3 rounded-full transition-all duration-1000 ease-out relative",
								...
								_jsxs("div", {
									className: "absolute -top-6 right-0 text-xs text-vscode-descriptionForeground",
						...
						_jsxs("div", {
							...
							children: [
								...
								_jsx("div", {
									className: `text-lg font-mono font-medium text-vscode-foreground ${status.remainingTime && status.remainingTime < 60000 ? "animate-pulse text-red-500" : ""}`,
									children: formatTime(status.remainingTime || 0),
								}),
							],
						}),
						status.remainingTime &&
							status.remainingTime < 60000 &&
							_jsx("div", {
					...
					children: [
						status.state === "waiting" &&
							...
							_jsx(Button, {
								...
								variant: "secondary",
								className: "w-full",
								children: "\uD83D\uDCDD Open Context File",
							}),
						_jsx(Button, {
							onClick: () => onFallback?.(),
							variant: "default",
							className: "w-full",
							children: "\uD83D\uDE80 Use Intelligent Compression Instead",
						}),
					],
				}),
			status.contextFile &&
				_jsxs("div", {
					className:
						"mt-6 p-4 bg-vscode-input-background rounded-lg border border-vscode-editor-border w-full max-w-md",
					children: [
						_jsxs("div", {
						...
						_jsx("div", {
							className: "text-xs text-vscode-descriptionForeground font-mono truncate mb-2",
							children: status.contextFile.split("/").pop(),
						}),
						_jsx("div", {
			...
			status.startTime &&
				_jsxs("div", {
					className: "mt-4 text-xs text-vscode-descriptionForeground text-center",
					children: ["Started: ", new Date(status.startTime).toLocaleTimeString()],
				}),
		],
	})
}
