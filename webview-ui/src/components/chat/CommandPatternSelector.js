...
export const CommandPatternSelector = ({
	...
	return _jsxs("div", {
		className: "border-t border-vscode-panel-border/50 bg-vscode-sideBar-background/30",
		children: [
			_jsx("button", {
				onClick: () => setIsExpanded(!isExpanded),
				className:
					"w-full px-3 py-2 flex items-center justify-between hover:bg-vscode-list-hoverBackground transition-colors",
				children: _jsxs("div", {
					className: "group flex items-center gap-2 cursor-pointer w-full text-left",
					children: [
						_jsxs("span", {
							className: cn(
							...
							children: [
								_jsx(CheckCheck, { className: "size-3 inline-block mr-2" }),
			...
			isExpanded &&
				_jsx("div", {
					className: "pl-6 pr-2 pt-1 pb-2 space-y-2",
					children: allPatterns.map((item) => {
									...
									_jsx("div", {
										...
										children: editState.isEditing
											? _jsx("input", {
													...
													className:
														"font-mono text-xs bg-vscode-input-background text-vscode-input-foreground border border-vscode-input-border rounded px-2 py-1.5 w-full focus:outline-0 focus:ring-1 focus:ring-vscode-focusBorder",
											...
											: _jsxs("div", {
													...
													className:
														"font-mono text-xs text-vscode-foreground cursor-pointer hover:bg-vscode-list-hoverBackground px-2 py-1.5 rounded transition-colors border border-transparent break-all",
													title: "Click to edit pattern",
													children: [
														_jsx("span", {
															className: "break-all",
															children: editState.value,
														}),
														item.description &&
															_jsxs("span", {
																className: "text-vscode-descriptionForeground ml-2",
