...
export const BatchFilePermission = memo(({ files = [], onPermissionResponse, ts }) => {
	...
	return _jsx("div", {
		className: "pt-[5px]",
		children: _jsx("div", {
			className: "flex flex-col gap-0 border border-border rounded-md p-1",
					...
					"div",
					{
						...
						children: _jsx(ToolUseBlock, {
							...
							children: _jsxs(ToolUseBlockHeader, {
								...
								children: [
									file.path?.startsWith(".") && _jsx("span", { children: "." }),
									_jsxs("span", {
										className: "whitespace-nowrap overflow-hidden text-ellipsis text-left mr-2 rtl",
										children: [
									...
									_jsx("span", { className: "codicon codicon-link-external text-[13.5px] my-[1px]" }),
								],
							}),
						}),
					},
