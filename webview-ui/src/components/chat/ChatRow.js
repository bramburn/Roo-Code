...
const ChatRow = memo(
	(props) => {
		...
		const [chatrow, { height }] = useSize(
			_jsx("div", { className: "px-[15px] py-[10px] pr-[6px]", children: _jsx(ChatRowContent, { ...props }) }),
		)
		useEffect(() => {
			...
			case "command":
				return [
					isCommandExecuting
						...
						: _jsx(TerminalSquare, { className: "size-4", "aria-label": "Terminal icon" }),
					_jsx("span", {
						style: { color: normalColor, fontWeight: "bold" },
						children: t("chat:commandExecution.running"),
					}),
				]
			case "use_mcp_server":
			...
			case "completion_result":
				return [
					...
					_jsx("span", {
						...
						children: t("chat:taskCompleted"),
					}),
				]
			case "api_req_retry_delayed":
				return []
			case "api_req_started":
				const getIconSpan = (iconName, color) =>
					_jsx("div", {
						style: {
							width: 16,
							height: 16,
				...
				return [
					...
					apiReqCancelReason !== null && apiReqCancelReason !== undefined
						? apiReqCancelReason === "user_cancelled"
							? _jsx("span", {
									style: { color: normalColor, fontWeight: "bold" },
									children: t("chat:apiRequest.cancelled"),
								})
							: _jsx("span", {
									style: { color: errorColor, fontWeight: "bold" },
									children: t("chat:apiRequest.streamingFailed"),
								})
						: cost !== null && cost !== undefined
							? _jsx("span", { style: { color: normalColor }, children: t("chat:apiRequest.title") })
							: apiRequestFailedMessage
								? _jsx("span", { style: { color: errorColor }, children: t("chat:apiRequest.failed") })
								: _jsx("span", {
										style: { color: normalColor },
										children: t("chat:apiRequest.streaming"),
									}),
				]
			case "followup":
				return [
					...
					_jsx("span", {
						style: { color: normalColor, fontWeight: "bold" },
						children: t("chat:questions.hasQuestion"),
					}),
				]
			default:
				return [null, null]
	...
	if (tool) {
		...
		switch (tool.tool) {
					...
					return _jsxs(_Fragment, {
						children: [
							_jsxs("div", {
								style: headerStyle,
								children: [
									_jsx(FileDiff, { className: "w-4 shrink-0", "aria-label": "Batch diff icon" }),
									_jsx("span", {
										style: { fontWeight: "bold" },
										children: t("chat:fileOperations.wantsToApplyBatchChanges"),
									}),
								],
							}),
							_jsx(BatchDiffApproval, { files: tool.batchDiffs, ts: message.ts }),
						],
					})
				}
			...
			case "updateTodoList": {
				...
				return _jsx(UpdateTodoListToolBlock, {
					todos: todos,
					...
					return _jsxs(_Fragment, {
						children: [
							_jsxs("div", {
								style: headerStyle,
								children: [
									_jsx(Eye, { className: "w-4 shrink-0", "aria-label": "View files icon" }),
									_jsx("span", {
										style: { fontWeight: "bold" },
										children: t("chat:fileOperations.wantsToReadMultiple"),
									}),
								],
							}),
							_jsx(BatchFilePermission, {
				...
				return _jsxs(_Fragment, {
					children: [
						_jsxs("div", {
							style: headerStyle,
							children: [
								_jsx(FileCode2, { className: "w-4 shrink-0", "aria-label": "Read file icon" }),
								_jsx("span", {
									style: { fontWeight: "bold" },
									children:
										message.type === "ask"
						...
						_jsx("div", {
							className: "pl-6",
							children: _jsx(ToolUseBlock, {
								children: _jsxs(ToolUseBlockHeader, {
									className: "group",
									...
									children: [
										...
										_jsxs("span", {
											className:
												"whitespace-nowrap overflow-hidden text-ellipsis text-left mr-2 rtl",
											children: [
										...
										_jsx(SquareArrowOutUpRight, {
											className:
												"w-4 shrink-0 codicon codicon-link-external opacity-0 group-hover:opacity-100 transition-opacity",
					...
					children: [
						_jsxs("div", {
							...
							children: [
								...
								_jsx("span", {
									style: { fontWeight: "bold" },
									children: t("chat:instructions.wantsToFetch"),
								}),
							],
						}),
						_jsx("div", {
				...
				return _jsxs(_Fragment, {
					children: [
						_jsxs("div", {
							style: headerStyle,
							children: [
								_jsx(ListTree, { className: "w-4 shrink-0", "aria-label": "List files icon" }),
								_jsx("span", {
									style: { fontWeight: "bold" },
									children:
										message.type === "ask"
				...
				return _jsxs(_Fragment, {
					children: [
						_jsxs("div", {
							style: headerStyle,
							children: [
								_jsx(FolderTree, { className: "w-4 shrink-0", "aria-label": "Folder tree icon" }),
								_jsx("span", {
									style: { fontWeight: "bold" },
									children:
										message.type === "ask"
							...
							children: [
								...
								_jsx("span", {
									...
									children:
										message.type === "ask"
											? _jsx(Trans, {
													i18nKey: tool.isOutsideWorkspace
			...
			case "switchMode":
				return _jsx(_Fragment, {
					children: _jsxs("div", {
						style: headerStyle,
						children: [
							_jsx(PocketKnife, { className: "w-4 shrink-0", "aria-label": "Switch mode icon" }),
							_jsx("span", {
								style: { fontWeight: "bold" },
								children:
									message.type === "ask"
							...
							children: [
								...
								_jsx("span", {
									...
									children: _jsx(Trans, {
										...
										components: { code: _jsx("code", { children: tool.mode }) },
										values: { mode: tool.mode },
									}),
								}),
							],
						...
						_jsxs("div", {
							...
							children: [
								_jsxs("div", {
									...
									children: [
										_jsx("span", { className: "codicon codicon-arrow-right" }),
										t("chat:subtasks.newTaskContent"),
									],
								}),
								_jsx("div", {
									style: { padding: "12px 16px", backgroundColor: "var(--vscode-editor-background)" },
									children: _jsx(MarkdownBlock, { markdown: tool.content }),
								}),
							],
						}),
					],
					...
					children: [
						_jsxs("div", {
							...
							children: [
								...
								_jsx("span", {
									style: { fontWeight: "bold" },
									children: t("chat:subtasks.wantsToFinish"),
								}),
							],
						}),
						_jsxs("div", {
										...
										_jsxs("div", {
											...
											children: [
												_jsxs("span", {
													...
													children: ["/", slashCommandInfo.command],
												}),
												slashCommandInfo.source &&
													_jsx(VSCodeBadge, {
														style: { fontSize: "calc(var(--vscode-font-size) - 2px)" },
														children: slashCommandInfo.source,
													}),
											],
										}),
										_jsx("span", {
												...
												_jsxs("div", {
													children: [
														...
														_jsx("span", {
															...
															children: slashCommandInfo.args,
														}),
													],
												}),
		...
		case "say":
			switch (message.say) {
						...
						children: _jsxs("div", {
							...
							children: [
								_jsxs("div", {
									...
									children: [
										_jsx("span", { className: "codicon codicon-arrow-left" }),
						...
						children: [
							...
							(((cost === null || cost === undefined) && apiRequestFailedMessage) ||
								...
								_jsx(ErrorRow, {
									...
									additionalContent: apiRequestFailedMessage?.toLowerCase().includes("powershell")
										? _jsxs(_Fragment, {
												children: [
													_jsx("br", {}),
													_jsx("br", {}),
						...
						children: [
							_jsxs("div", {
								...
								children: [
									...
									_jsx("span", { style: { fontWeight: "bold" }, children: t("chat:text.rooSaid") }),
								],
							}),
							_jsxs("div", {
								className: "pl-6",
								children: [
									_jsx(Markdown, { markdown: message.text, partial: message.partial }),
									message.images &&
										message.images.length > 0 &&
										_jsx("div", {
											style: { marginTop: "10px" },
											children: message.images.map((image, index) =>
												_jsx(ImageBlock, { imageData: image }, index),
											),
										}),
								],
							}),
					...
					return _jsxs("div", {
						...
						children: [
							_jsxs("div", {
								style: headerStyle,
								children: [
									_jsx(User, { className: "w-4 shrink-0", "aria-label": "User icon" }),
									_jsx("span", {
										style: { fontWeight: "bold" },
										children: t("chat:feedback.youSaid"),
									}),
								],
							}),
							_jsxs("div", {
									...
									isEditing
										...
										: _jsxs("div", {
												...
												children: [
													_jsx("div", {
														className:
															"flex-grow px-2 py-1 wrap-anywhere rounded-lg transition-colors",
														onClick: (e) => {
															e.stopPropagation()
															if (!isStreaming) {
																handleEditClick()
													...
													_jsxs("div", {
														...
														children: [
															_jsx("div", {
																className:
																	"cursor-pointer shrink-0 opacity-0 group-hover:opacity-100 transition-opacity",
																style: {
															...
															_jsx("div", {
																...
																children: _jsx(Trash2, {
																	className: "w-4 shrink-0",
																	"aria-label": "Delete message icon",
																}),
															}),
														],
													}),
				...
				case "completion_result":
					return _jsxs(_Fragment, {
						children: [
							...
							_jsx("div", {
								className: "border-l border-green-600/30 ml-2 pl-4 pb-1",
								...
								children: [
									_jsxs("div", {
										...
										children: [
											...
											_jsx("span", {
												style: { fontWeight: "bold" },
												children: t("chat:slashCommand.didRun"),
											}),
										],
									}),
									_jsx("div", {
				...
				case "image":
					...
					return _jsx("div", {
						style: { marginTop: "10px" },
						children: _jsx(ImageBlock, { imageUri: imageInfo.imageUri, imagePath: imageInfo.imagePath }),
					})
				default:
					return _jsxs(_Fragment, {
						children: [
							title && _jsxs("div", { style: headerStyle, children: [icon, title] }),
							_jsx("div", {
								style: { paddingTop: 10 },
								children: _jsx(Markdown, { markdown: message.text, partial: message.partial }),
							}),
						],
					})
			}
				...
				case "use_mcp_server":
					...
					return _jsxs(_Fragment, {
						children: [
							...
							_jsxs("div", {
								className:
									"w-full bg-vscode-editor-background border border-vscode-border rounded-xs p-2 mt-2",
								children: [
