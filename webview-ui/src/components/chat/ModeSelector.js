		...
		children: [
			_jsx(StandardTooltip, {
				...
				children: _jsx(PopoverTrigger, {
					...
					children: _jsx("span", { className: "truncate", children: selectedMode?.name || "" }),
				}),
			}),
			_jsx(PopoverContent, {
				align: "start",
							...
							children:
								filteredModes.length === 0 && searchValue
									? _jsx("div", {
											...
											children: t("chat:modeSelector.noResults"),
										})
									: _jsx("div", {
											className: "py-1",
															...
															_jsxs("div", {
																...
																children: [
																	...
																	mode.description &&
																		_jsx("div", {
																			className:
																				"text-xs text-vscode-descriptionForeground truncate",
																			children: mode.description,
																		}),
																],
															}),
															isSelected &&
																_jsx(Check, { className: "ml-auto size-4 p-0.5" }),
														],
													},
													mode.slug,
												)
