...
const ChatViewComponent = ({ isHidden, showAnnouncement, hideAnnouncement }, ref) => {
	...
	const everVisibleMessagesTsRef = useRef(
		new LRUCache({
			max: 100,
			ttl: 1000 * 60 * 5,
		}),
	...
	const itemContent = useCallback(
		(index, messageOrGroup) => {
			// browser session group
			if (Array.isArray(messageOrGroup)) {
				return _jsx(BrowserSessionRow, {
					messages: messageOrGroup,
					isLast: index === groupedMessages.length - 1,
					lastModifiedMessage: modifiedMessages.at(-1),
					onHeightChange: handleRowHeightChange,
					isStreaming: isStreaming,
					isExpanded: (messageTs) => expandedRows[messageTs] ?? false,
					onToggleExpand: (messageTs) => {
						setExpandedRows((prev) => ({
							...prev,
	...
	return _jsxs("div", {
		...
		children: [
			telemetrySetting === "unset" && _jsx(TelemetryBanner, {}),
			...
			task
				? _jsxs(_Fragment, {
						children: [
							...
							hasSystemPromptOverride &&
								_jsx("div", { className: "px-3", children: _jsx(SystemPromptWarning, {}) }),
							checkpointWarning &&
								_jsx("div", {
									className: "px-3",
									children: _jsx(CheckpointWarning, { warning: checkpointWarning }),
								}),
						],
					})
				: _jsxs("div", {
						className: "flex-1 min-h-0 overflow-y-auto flex flex-col gap-4 relative",
						children: [
							tasks.length !== 0 &&
								_jsx("div", {
									className: "flex text-vscode-descriptionForeground w-full mx-auto px-5 pt-3",
									children: _jsxs("div", {
										...
										children: [
											tasks.length < 10 &&
												_jsx("span", {
													...
													children: t("history:recentTasks"),
												}),
											_jsx("span", {
							...
							_jsxs("div", {
								...
								children: [
									...
									_jsx("div", {
										...
										children:
											cloudIsAuthenticated || taskHistory.length < 4
												? _jsx(RooTips, {})
												: _jsx(_Fragment, {
														children: _jsx(DismissibleUpsell, {
															upsellId: "taskList",
															icon: _jsx(Cloud, { className: "size-4 mt-0.5 shrink-0" }),
															onClick: () => openUpsell(),
									...
									taskHistory.length > 0 && isExpanded && _jsx(HistoryPreview, {}),
								],
							}),
						],
					}),
								...
								children: showScrollToBottom
									? _jsx(StandardTooltip, {
											...
											children: _jsx(VSCodeButton, {
												...
												children: _jsx("span", { className: "codicon codicon-chevron-down" }),
											}),
										})
									: _jsxs(_Fragment, {
											children: [
			...
			isProfileDisabled && _jsx("div", { className: "px-3", children: _jsx(ProfileViolationWarning, {}) }),
			_jsx("div", { id: "roo-portal" }),
			_jsx(CloudUpsellDialog, { open: isUpsellOpen, onOpenChange: closeUpsell, onConnect: handleConnect }),
		],
	})
}
