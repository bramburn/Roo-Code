	...
	return _jsxs(_Fragment, {
		children: [
			_jsx(StandardTooltip, {
				content: t("chat:task.openInCloud"),
				children: _jsx(Button, {
					...
					children: _jsx(CloudUpload, { className: "h-4 w-4" }),
				}),
			}),
			_jsx(Dialog, {
				open: dialogOpen,
				...
				children: _jsxs(DialogContent, {
					className: "max-w-100",
					children: [
						_jsx(DialogHeader, { children: _jsx(DialogTitle, { children: t("chat:task.openInCloud") }) }),
						_jsxs("div", {
							className: "flex flex-col space-y-4",
							children: [
								_jsx("p", {
									className: "text-center md:text-left max-w-80",
									children: t("chat:task.openInCloudIntro"),
								}),
								_jsx("div", {
									className: "flex justify-center md:justify-start",
									children: _jsx("div", {
										className:
											"w-[170px] h-[170px] bg-white rounded-lg border-border cursor-pointer hover:opacity-70 transition-opacity",
										onClick: () => vscode.postMessage({ type: "openExternal", url: cloudTaskUrl }),
										title: t("chat:task.openInCloud"),
										children: _jsx("canvas", { ref: canvasRef, className: "m-[15px]" }),
									}),
								}),
								_jsxs("div", {
