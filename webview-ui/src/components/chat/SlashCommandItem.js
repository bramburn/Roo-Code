...
export const SlashCommandItem = ({ command, onDelete, onClick }) => {
	...
	return _jsxs("div", {
		className: "px-4 py-2 text-sm flex items-center group hover:bg-vscode-list-hoverBackground",
		children: [
			_jsx("div", {
				...
				children: _jsxs("div", {
					children: [
						_jsx("span", { className: "truncate text-vscode-foreground", children: command.name }),
						command.description &&
							_jsx("div", {
				...
				_jsxs("div", {
					...
					children: [
						_jsx(StandardTooltip, {
							content: t("chat:slashCommands.editCommand"),
						...
						_jsx(StandardTooltip, {
							content: t("chat:slashCommands.deleteCommand"),
							children: _jsx(Button, {
								variant: "ghost",
								size: "icon",
								tabIndex: -1,
								...
								className:
									"size-6 flex items-center justify-center opacity-60 hover:opacity-100 hover:text-red-400",
