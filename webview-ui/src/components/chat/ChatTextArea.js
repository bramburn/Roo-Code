...
export const ChatTextArea = forwardRef(
	(
		...
		return _jsxs("div", {
			...
			children: [
				_jsx("div", {
					className: cn(!isEditMode && "relative"),
					children: _jsxs("div", {
						...
						children: [
							...
							_jsxs("div", {
								...
								children: [
									...
									_jsxs("div", {
										className: "absolute bottom-2 right-1 z-30 flex flex-col items-center gap-0",
										children: [
											_jsx(StandardTooltip, {
												content: t("chat:addImages"),
												children: _jsx("button", {
													...
													children: _jsx(Image, { className: "w-4 h-4" }),
												}),
											}),
											_jsx(StandardTooltip, {
												content: t("chat:enhancePrompt"),
												children: _jsx("button", {
											...
											isEditMode &&
												_jsx(StandardTooltip, {
													...
													children: _jsx("button", {
														...
														children: _jsx(MessageSquareX, { className: "w-4 h-4" }),
													}),
												}),
											_jsx(StandardTooltip, {
												content: t("chat:sendMessage"),
												children: _jsx("button", {
													...
													children: _jsx(SendHorizontal, { className: "w-4 h-4" }),
												}),
											}),
										],
									}),
									!inputValue &&
										_jsx("div", {
											...
											children: placeholderBottomText,
										}),
								],
							}),
						],
				...
				_jsxs("div", {
					...
					children: [
						_jsxs("div", {
							className: "flex items-center gap-2 min-w-0 overflow-clip flex-1",
							children: [
								_jsx(ModeSelector, {
									value: mode,
								...
								isTtsPlaying &&
									_jsx(StandardTooltip, {
										...
										children: _jsx("button", {
											...
											children: _jsx(VolumeX, { className: "w-4 h-4" }),
										}),
									}),
								!isEditMode ? _jsx(IndexingStatusBadge, {}) : null,
								!isEditMode && cloudUserInfo && _jsx(CloudAccountSwitcher, {}),
							],
						}),
					],
				}),
