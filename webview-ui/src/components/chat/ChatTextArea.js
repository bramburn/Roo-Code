...
import { ContextMenuOptionType, getContextMenuOptions, insertMention, removeMention, shouldShowContextMenu, } from "@src/utils/context-mentions";
...
export const ChatTextArea = forwardRef(({ inputValue, setInputValue, selectApiConfigDisabled, placeholderText, selectedImages, setSelectedImages, onSend, onSelectImages, shouldDisableImages, onHeightChange, mode, setMode, modeShortcutText, isEditMode = false, onCancel, }, ref) => {
    const { t } = useAppTranslation();
    const { filePaths, openedTabs, currentApiConfigName, listApiConfigMeta, customModes, customModePrompts, cwd, pinnedApiConfigs, togglePinnedApiConfig, taskHistory, clineMessages, commands, cloudUserInfo, } = useExtensionState();
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            if (contextMenuContainerRef.current &&
                !contextMenuContainerRef.current.contains(event.target)) {
    ...
    const handleMentionSelect = useCallback((type, value) => {
        ...
        if (textAreaRef.current) {
            ...
            const { newValue, mentionIndex } = insertMention(textAreaRef.current.value, cursorPosition, insertValue, isSlashCommand);
            setInputValue(newValue);
        ...
        if (showContextMenu) {
            ...
            if (event.key === "ArrowUp" || event.key === "ArrowDown") {
                ...
                setSelectedMenuIndex((prevIndex) => {
                    ...
                    const selectableOptions = options.filter((option) => option.type !== ContextMenuOptionType.URL &&
                    ...
                    const newSelectableIndex = (currentSelectableIndex + direction + selectableOptions.length) %
            ...
            if ((event.key === "Enter" || event.key === "Tab") && selectedMenuIndex !== -1) {
                event.preventDefault();
                const selectedOption = getContextMenuOptions(searchQuery, selectedType, queryItems, fileSearchResults, allModes, commands)[selectedMenuIndex];
                if (selectedOption &&
    ...
    const updateHighlights = useCallback(() => {
        ...
        const isValidCommand = (commandName) => {
    ...
    const handleApiConfigChange = useCallback((value) => {
        vscode.postMessage({ type: "loadApiConfigurationById", text: value });
    }, []);
    return (_jsxs("div", { className: cn("flex flex-col gap-1 bg-editor-background outline-none border border-none box-border", isEditMode ? "p-2 w-full" : "relative px-1.5 pb-1 w-[calc(100%-16px)] ml-auto mr-auto"), children: [_jsx("div", { className: cn(!isEditMode && "relative"), children: _jsxs("div", { className: cn("chat-text-area", !isEditMode && "relative", "flex", "flex-col", "outline-none"), onDrop: handleDrop, onDragOver: (e) => {
                        ...
                        if (e.clientX <= rect.left ||
                            ...
                            setIsDraggingOver(false);
                    ...
                    }, children: [showContextMenu && (_jsx("div", { ref: contextMenuContainerRef, className: cn("absolute", "bottom-full", isEditMode ? "left-6" : "left-0", "right-0", "z-[1000]", isEditMode ? "-mb-3" : "mb-2", "filter", "drop-shadow-md"), children: _jsx(ContextMenu, { onSelect: handleMentionSelect, searchQuery: searchQuery, inputValue: inputValue, onMouseDown: handleMenuMouseDown, selectedIndex: selectedMenuIndex, setSelectedIndex: setSelectedMenuIndex, selectedType: selectedType, queryItems: queryItems, modes: allModes, loading: searchLoading, dynamicSearchResults: fileSearchResults, commands: commands }) })), _jsxs("div", { className: cn("relative", "flex-1", "flex", "flex-col-reverse", "min-h-0", "overflow-hidden", "rounded"), children: [_jsx("div", { ref: highlightLayerRef, "data-testid": "highlight-layer", className: cn("absolute", "inset-0", "pointer-events-none", "whitespace-pre-wrap", "break-words", "text-transparent", "overflow-hidden", "font-vscode-font-family", "text-vscode-editor-font-size", "leading-vscode-editor-line-height", isFocused
                                        ? "border border-vscode-focusBorder outline outline-vscode-focusBorder"
                                        : isDraggingOver
                                            ? "border-2 border-dashed border-vscode-focusBorder"
                                            : "border border-transparent", "pl-2", "py-2", isEditMode ? "pr-20" : "pr-9", "z-10", "forced-color-adjust-none", "rounded"), style: {
                                        color: "transparent",
                                    } }), _jsx(DynamicTextArea, { ref: (el) => {
                                        ...
                                        handleInputChange(e);
                                        updateHighlights();
                                    }, onFocus: () => setIsFocused(true), onKeyDown: (e) => {
                                        ...
                                        handleKeyDown(e);
                                    }, onKeyUp: handleKeyUp, onBlur: handleBlur, onPaste: handlePaste, onSelect: updateCursorPosition, onMouseUp: updateCursorPosition, onHeightChange: (height) => {
                                        if (textAreaBaseHeight === undefined || height < textAreaBaseHeight) {
                                            setTextAreaBaseHeight(height);
                                        }
                                        onHeightChange?.(height);
                                    }, placeholder: placeholderText, minRows: 3, maxRows: 15, autoFocus: true, className: cn("w-full", "text-vscode-input-foreground", "font-vscode-font-family", "text-vscode-editor-font-size", "leading-vscode-editor-line-height", "cursor-text", "py-2 pl-2", isFocused
                                        ? "border border-vscode-focusBorder outline outline-vscode-focusBorder"
                                        : isDraggingOver
                                            ? "border-2 border-dashed border-vscode-focusBorder"
                                            : "border border-transparent", isDraggingOver
                                        ? "bg-[color-mix(in_srgb,var(--vscode-input-background)_95%,var(--vscode-focusBorder))]"
                                        : "bg-vscode-input-background", "transition-background-color duration-150 ease-in-out", "will-change-background-color", "min-h-[94px]", "box-border", "rounded", "resize-none", "overflow-x-hidden", "overflow-y-auto", isEditMode ? "pr-20" : "pr-9", "flex-none flex-grow", "z-[2]", "scrollbar-none", "scrollbar-hide"), onScroll: () => updateHighlights() }), _jsxs("div", { className: "absolute bottom-2 right-1 z-30 flex flex-col items-center gap-0", children: [_jsx(StandardTooltip, { content: t("chat:addImages"), children: _jsx("button", { "aria-label": t("chat:addImages"), disabled: shouldDisableImages, onClick: !shouldDisableImages ? onSelectImages : undefined, className: cn("relative inline-flex items-center justify-center", "bg-transparent border-none p-1.5", "rounded-md min-w-[28px] min-h-[28px]", "text-vscode-descriptionForeground hover:text-vscode-foreground", "transition-all duration-1000", "cursor-pointer", !shouldDisableImages
                                                    ? "opacity-50 hover:opacity-100 delay-750 pointer-events-auto"
                                                    : "opacity-0 pointer-events-none duration-200 delay-0", !shouldDisableImages &&
                                                    "hover:bg-[rgba(255,255,255,0.03)] hover:border-[rgba(255,255,255,0.15)]", "focus:outline-none focus-visible:ring-1 focus-visible:ring-vscode-focusBorder", !shouldDisableImages && "active:bg-[rgba(255,255,255,0.1)]", shouldDisableImages &&
                                                    "opacity-40 cursor-not-allowed grayscale-[30%] hover:bg-transparent hover:border-[rgba(255,255,255,0.08)] active:bg-transparent"), children: _jsx(Image, { className: "w-4 h-4" }) }) }), _jsx(StandardTooltip, { content: t("chat:enhancePrompt"), children: _jsx("button", { "aria-label": t("chat:enhancePrompt"), disabled: false, onClick: handleEnhancePrompt, className: cn("relative inline-flex items-center justify-center", "bg-transparent border-none p-1.5", "rounded-md min-w-[28px] min-h-[28px]", "text-vscode-descriptionForeground hover:text-vscode-foreground", "transition-all duration-1000", "cursor-pointer", hasInputContent
                                                    ? "opacity-50 hover:opacity-100 delay-750 pointer-events-auto"
                                                    : "opacity-0 pointer-events-none duration-200 delay-0", hasInputContent &&
                                                    "hover:bg-[rgba(255,255,255,0.03)] hover:border-[rgba(255,255,255,0.15)]", "focus:outline-none focus-visible:ring-1 focus-visible:ring-vscode-focusBorder", hasInputContent && "active:bg-[rgba(255,255,255,0.1)]"), children: _jsx(WandSparkles, { className: cn("w-4 h-4", isEnhancingPrompt && "animate-spin") }) }) }), isEditMode && (_jsx(StandardTooltip, { content: t("chat:cancel.title"), children: _jsx("button", { "aria-label": t("chat:cancel.title"), disabled: false, onClick: onCancel, className: cn("relative inline-flex items-center justify-center", "bg-transparent border-none p-1.5", "rounded-md min-w-[28px] min-h-[28px]", "opacity-60 hover:opacity-100 text-vscode-descriptionForeground hover:text-vscode-foreground", "transition-all duration-150", "hover:bg-[rgba(255,255,255,0.03)] hover:border-[rgba(255,255,255,0.15)]", "focus:outline-none focus-visible:ring-1 focus-visible:ring-vscode-focusBorder", "active:bg-[rgba(255,255,255,0.1)]", "cursor-pointer"), children: _jsx(MessageSquareX, { className: "w-4 h-4" }) }) })), _jsx(StandardTooltip, { content: t("chat:sendMessage"), children: _jsx("button", { "aria-label": t("chat:sendMessage"), disabled: false, onClick: onSend, className: cn("relative inline-flex items-center justify-center", "bg-transparent border-none p-1.5", "rounded-md min-w-[28px] min-h-[28px]", "text-vscode-descriptionForeground hover:text-vscode-foreground", "transition-all duration-200", hasInputContent
                                                    ? "opacity-100 hover:opacity-100 pointer-events-auto"
                                                    : "opacity-0 pointer-events-none", hasInputContent &&
                                                    "hover:bg-[rgba(255,255,255,0.03)] hover:border-[rgba(255,255,255,0.15)]", "focus:outline-none focus-visible:ring-1 focus-visible:ring-vscode-focusBorder", hasInputContent && "active:bg-[rgba(255,255,255,0.1)]", hasInputContent && "cursor-pointer"), children: _jsx(SendHorizontal, { className: "w-4 h-4" }) }) })] }), !inputValue && (_jsx("div", { className: cn("absolute left-2 z-30 flex items-center h-8 font-vscode-font-family text-vscode-editor-font-size leading-vscode-editor-line-height", isEditMode ? "pr-20" : "pr-9"), style: {
                                        bottom: "0.75rem",
                                        color: "color-mix(in oklab, var(--vscode-input-foreground) 50%, transparent)",
                                        userSelect: "none",
                                        pointerEvents: "none",
                                    }, children: placeholderBottomText }))] })] }) }), selectedImages.length > 0 && (_jsx(Thumbnails, { images: selectedImages, setImages: setSelectedImages, style: {
                    left: "16px",
                    zIndex: 2,
                    marginBottom: 0,
                } })), _jsxs("div", { className: "flex items-center gap-2", children: [_jsxs("div", { className: "flex items-center gap-2 min-w-0 overflow-clip flex-1", children: [_jsx(ModeSelector, { value: mode, title: t("chat:selectMode"), onChange: handleModeChange, triggerClassName: "text-ellipsis overflow-hidden flex-shrink-0", modeShortcutText: modeShortcutText, customModes: customModes, customModePrompts: customModePrompts }), _jsx(ApiConfigSelector, { value: currentConfigId, displayName: displayName, disabled: selectApiConfigDisabled, title: t("chat:selectApiConfig"), onChange: handleApiConfigChange, triggerClassName: "min-w-[28px] text-ellipsis overflow-hidden flex-shrink", listApiConfigMeta: listApiConfigMeta || [], pinnedApiConfigs: pinnedApiConfigs, togglePinnedApiConfig: togglePinnedApiConfig }), _jsx(AutoApproveDropdown, { triggerClassName: "min-w-[28px] text-ellipsis overflow-hidden flex-shrink" })] }), _jsxs("div", { className: cn("flex flex-shrink-0 items-center gap-0.5", !isEditMode && cloudUserInfo ? "" : "pr-2"), children: [isTtsPlaying && (_jsx(StandardTooltip, { content: t("chat:stopTts"), children: _jsx("button", { "aria-label": t("chat:stopTts"), onClick: () => vscode.postMessage({ type: "stopTts" }), className: cn("relative inline-flex items-center justify-center", "bg-transparent border-none p-1.5", "rounded-md min-w-[28px] min-h-[28px]", "text-vscode-foreground opacity-85", "transition-all duration-150", "hover:opacity-100 hover:bg-[rgba(255,255,255,0.03)] hover:border-[rgba(255,255,255,0.15)]", "focus:outline-none focus-visible:ring-1 focus-visible:ring-vscode-focusBorder", "active:bg-[rgba(255,255,255,0.1)]", "cursor-pointer"), children: _jsx(VolumeX, { className: "w-4 h-4" }) }) })), !isEditMode ? _jsx(IndexingStatusBadge, {}) : null, !isEditMode && cloudUserInfo && _jsx(CloudAccountSwitcher, {})] })] })] }));
});
