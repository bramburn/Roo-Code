		...
		children: [
			_jsxs("div", {
				...
				children: [
					_jsxs("div", {
						...
						children: [
							_jsx(Lightbulb, { className: "w-4" }),
							_jsx("span", {
								className: "font-bold text-vscode-foreground",
								children: t("chat:reasoning.thinking"),
							}),
							elapsed > 0 &&
								_jsx("span", {
									className: "text-sm text-vscode-descriptionForeground mt-0.5",
									children: secondsLabel,
								}),
						],
					}),
					_jsx("div", {
			...
			(content?.trim()?.length ?? 0) > 0 &&
				...
				_jsx("div", {
					...
					children: _jsx(MarkdownBlock, { markdown: content }),
				}),
		],
	})
}
