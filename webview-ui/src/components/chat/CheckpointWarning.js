...
export const CheckpointWarning = ({ warning }) => {
	const settingsLink = _jsx(VSCodeLink, {
		href: "#",
		onClick: (e) => {
			e.preventDefault()
			window.postMessage(
	...
	return _jsxs("div", {
		className:
			"flex items-center p-3 my-3 bg-vscode-inputValidation-warningBackground border border-vscode-inputValidation-warningBorder rounded",
		children: [
			_jsx("span", { className: "codicon codicon-loading codicon-modifier-spin mr-2" }),
			_jsx("span", {
