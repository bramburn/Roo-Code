...
export const McpExecution = ({
	...
	return _jsxs(_Fragment, {
		children: [
			...
			_jsxs("div", {
				className: "w-full bg-vscode-editor-background rounded-xs p-2",
				children: [
					...
					(isArguments || useMcpServer?.arguments || argumentsText) &&
						_jsx("div", {
							...
							children: _jsx(CodeBlock, { source: formattedArgumentsText, language: "json" }),
						}),
					_jsx(ResponseContainer, {
...
const ResponseContainerInternal = ({ isExpanded, response, isJson, hasArguments, isPartial = false }) => {
	...
	return _jsx("div", {
		...
		children: isJson
			? _jsx(CodeBlock, { source: response, language: "json" })
			: _jsx(Markdown, { markdown: response, partial: isPartial }),
	})
}
