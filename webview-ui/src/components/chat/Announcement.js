			...
			children: [
				_jsx(DialogHeader, {
					children: _jsx(DialogTitle, {
						children: t("chat:announcement.title", { version: Package.version }),
					}),
				}),
				_jsxs("div", {
					children: [
						_jsxs("div", {
							className: "mb-4",
							children: [
								_jsx("p", { className: "mb-3", children: t("chat:announcement.release.heading") }),
								_jsxs("ul", {
									className: "list-disc list-inside text-sm space-y-1",
									children: [
										_jsx("li", { children: t("chat:announcement.release.openRouterEmbeddings") }),
										_jsx("li", { children: t("chat:announcement.release.chutesDynamic") }),
										_jsx("li", { children: t("chat:announcement.release.queuedMessagesFix") }),
									],
								}),
							],
						}),
						_jsx("hr", { className: "my-4 border-vscode-widget-border" }),
						_jsxs("div", {
							children: [
								_jsx("p", { className: "mb-3", children: t("chat:announcement.cloudAgents.heading") }),
								_jsx("div", {
									className: "mb-3",
									children: _jsx(Trans, {
								...
								_jsx("p", {
									className: "mb-3 text-sm text-vscode-descriptionForeground",
									children: t("chat:announcement.cloudAgents.prFixerDescription"),
								}),
								_jsx("div", {
									className: "mt-4",
									children: _jsx(Button, {
										...
										className: "w-full",
										children: t("chat:announcement.cloudAgents.tryPrFixerButton"),
									}),
								}),
							],
						}),
