				...
				"div",
				{
					...
					children: [
						_jsxs("div", {
							...
							children: [
								_jsx("span", { className: "flex-shrink-0", children: config.name }),
								config.modelId &&
									_jsx(_Fragment, {
										children: _jsx("span", {
											className:
												"text-vscode-descriptionForeground opacity-70 min-w-0 overflow-hidden",
											style: { direction: "rtl", textOverflow: "ellipsis", whiteSpace: "nowrap" },
											children: config.modelId,
										}),
									}),
							],
						}),
						_jsxs("div", {
							...
							children: [
								isCurrentConfig &&
									_jsx("div", {
										className: "size-5 p-1 flex items-center justify-center",
										children: _jsx("span", { className: "codicon codicon-check text-xs" }),
									}),
								_jsx(StandardTooltip, {
									...
									children: _jsx(Button, {
										...
										children: _jsx("span", { className: "codicon codicon-pin text-xs opacity-50" }),
									}),
								}),
							],
						}),
		...
		children: [
			_jsx(StandardTooltip, {
				...
				children: _jsx(PopoverTrigger, {
					...
					children: _jsx("span", { className: "truncate", children: displayName }),
				}),
			}),
			_jsx(PopoverContent, {
				align: "start",
					...
					children: [
						listApiConfigMeta.length > 6
									...
									children: [
										...
										searchValue.length > 0 &&
											_jsx("div", {
												...
												children: _jsx("span", {
													className:
														"codicon codicon-close text-vscode-input-foreground opacity-50 hover:opacity-100 text-xs cursor-pointer",
							...
							: _jsx("div", {
									...
									children: _jsx("p", {
										className: "text-xs text-vscode-descriptionForeground m-0",
							...
							children:
								filteredConfigs.length === 0 && searchValue
									? _jsx("div", {
											...
											children: t("common:ui.no_results"),
										})
									: _jsxs("div", {
											className: "py-1",
											children: [
							...
							children: [
								...
								_jsxs("div", {
									...
									children: [
										listApiConfigMeta.length > 6 &&
											_jsx(StandardTooltip, {
												content: t("prompts:apiConfiguration.select"),
												children: _jsx("span", {
													className:
														"codicon codicon-info text-xs text-vscode-descriptionForeground opacity-70 hover:opacity-100 cursor-help",
												}),
											}),
										_jsx("h4", {
											className: "m-0 font-medium text-sm text-vscode-descriptionForeground",
