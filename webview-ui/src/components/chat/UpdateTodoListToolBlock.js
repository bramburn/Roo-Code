		...
		return _jsxs(ToolUseBlock, {
			children: [
				...
				_jsx("div", {
					...
					children: _jsx("span", { className: "text-vscode-descriptionForeground", children: "User Edits" }),
				}),
			],
		})
	}
	return _jsx(_Fragment, {
		children: _jsxs(ToolUseBlock, {
			children: [
				_jsx(ToolUseBlockHeader, {
					children: _jsxs("div", {
						className: "flex items-center w-full",
				...
				_jsx("div", {
					...
					children:
						Array.isArray(editTodos) && editTodos.length > 0
									...
									children: [
										...
										adding
											? _jsxs("li", {
													...
													children: [
														_jsx("span", { style: { width: 14, marginRight: 6 } }),
														_jsx("input", {
															ref: newInputRef,
															type: "text",
															value: newContent,
							...
							: _jsx(MarkdownBlock, { markdown: content }),
				}),
				deleteId &&
					_jsx("div", {
						style: {
						...
						children: _jsxs("div", {
							...
							children: [
								_jsx("div", {
									style: { marginBottom: 12, fontSize: 14, color: "#333" },
									children: "Are you sure you want to delete this todo item?",
								}),
								_jsxs("div", {
