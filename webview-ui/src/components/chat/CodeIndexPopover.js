			...
			_jsxs(Popover, {
				...
				children: [
					...
					_jsxs(PopoverContent, {
						...
						children: [
							_jsxs("div", {
								className: "p-3 border-b border-vscode-dropdown-border cursor-default",
								children: [
									_jsx("div", {
										className: "flex flex-row items-center gap-1 p-0 mt-0 mb-1 w-full",
										children: _jsx("h4", {
											className: "m-0 pb-2 flex-1",
											children: t("settings:codeIndex.title"),
										}),
									}),
									_jsx("p", {
										className: "my-0 pr-4 text-sm w-full",
										children: _jsx(Trans, {
											i18nKey: "settings:codeIndex.description",
								...
								children: [
											...
											children: [
												_jsx(VSCodeCheckbox, {
													...
													children: _jsx("span", {
														...
														children: t("settings:codeIndex.enableLabel"),
													}),
												}),
												_jsx(StandardTooltip, {
													...
													children: _jsx("span", {
														className:
															"codicon codicon-info text-xs text-vscode-descriptionForeground cursor-help",
													}),
												}),
											],
										}),
									...
									_jsxs("div", {
										...
										children: [
											_jsx("h4", {
												...
												children: t("settings:codeIndex.statusTitle"),
											}),
											_jsxs("div", {
											...
											indexingStatus.systemStatus === "Indexing" &&
												_jsx("div", {
													className: "mt-2",
													children: _jsx(ProgressPrimitive.Root, {
														className:
											...
											_jsxs("button", {
												...
												children: [
													...
													_jsx("span", {
														...
														children: t("settings:codeIndex.setupConfigLabel"),
													}),
												],
											}),
											isSetupSettingsOpen &&
													...
													children: [
														_jsxs("div", {
															...
															children: [
																_jsx("label", {
																	className: "text-sm font-medium",
																	children: t(
																		"settings:codeIndex.embedderProviderLabel",
																	),
																}),
																_jsxs(Select, {
																		...
																		_jsxs(SelectContent, {
																			children: [
																				_jsx(SelectItem, {
																					value: "openai",
																					children: t(
																						"settings:codeIndex.openaiProvider",
																					),
																				}),
																				_jsx(SelectItem, {
																					value: "ollama",
																					children: t(
																						"settings:codeIndex.ollamaProvider",
																					),
																				}),
																				_jsx(SelectItem, {
																					value: "openai-compatible",
																					children: t(
																						"settings:codeIndex.openaiCompatibleProvider",
																					),
																				}),
																				_jsx(SelectItem, {
																					value: "gemini",
																					children: t(
																						"settings:codeIndex.geminiProvider",
																					),
																				}),
																				_jsx(SelectItem, {
																					value: "mistral",
																					children: t(
																						"settings:codeIndex.mistralProvider",
																					),
																				}),
																				_jsx(SelectItem, {
																					value: "vercel-ai-gateway",
																					children: t(
																						"settings:codeIndex.vercelAiGatewayProvider",
																					),
																				}),
																				_jsx(SelectItem, {
																					value: "openrouter",
																	...
																	_jsxs("div", {
																		...
																		children: [
																			_jsx("label", {
																				className: "text-sm font-medium",
																				children: t(
																					"settings:codeIndex.openAiKeyLabel",
																				),
																			}),
																			_jsx(VSCodeTextField, {
																				type: "password",
																				value:
																					currentSettings.codeIndexOpenAiKey ||
																					"",
																				onInput: (e) =>
																					updateSetting(
																						"codeIndexOpenAiKey",
																			...
																			formErrors.codeIndexOpenAiKey &&
																				_jsx("p", {
																					className:
																						"text-xs text-vscode-errorForeground mt-1 mb-0",
																					children:
																						formErrors.codeIndexOpenAiKey,
																				}),
																		],
																	...
																	_jsxs("div", {
																		...
																		children: [
																			_jsx("label", {
																				className: "text-sm font-medium",
																				children: t(
																					"settings:codeIndex.modelLabel",
																				),
																			}),
																			_jsxs(VSCodeDropdown, {
																							...
																							return _jsxs(
																								VSCodeOption,
																								{
																									...
																									children: [
																										...
																										model
																											? t(
																													"settings:codeIndex.modelDimensions",
																													{
																														dimension:
																															model.dimension,
																													},
																	...
																	_jsxs("div", {
																		...
																		children: [
																			_jsx("label", {
																				className: "text-sm font-medium",
																				children: t(
																					"settings:codeIndex.ollamaBaseUrlLabel",
																				),
																			}),
																			_jsx(VSCodeTextField, {
																				value:
																	...
																	_jsxs("div", {
																		...
																		children: [
																			...
																			_jsx(VSCodeTextField, {
																				...
																				placeholder: t(
																					"settings:codeIndex.modelPlaceholder",
																				),
																				className: cn("w-full", {
																					"border-red-500":
																						formErrors.codebaseIndexEmbedderModelId,
																	...
																	_jsxs("div", {
																		...
																		children: [
																			_jsx("label", {
																				className: "text-sm font-medium",
																				children: t(
																					"settings:codeIndex.modelDimensionLabel",
																				),
																			}),
																			_jsx(VSCodeTextField, {
																				value:
																	...
																	_jsxs("div", {
																		...
																		children: [
																			_jsx("label", {
																				className: "text-sm font-medium",
																				children: t(
																					"settings:codeIndex.openAiCompatibleBaseUrlLabel",
																				),
																			}),
																			_jsx(VSCodeTextField, {
																				value:
																	...
																	_jsxs("div", {
																		...
																		children: [
																			_jsx("label", {
																				className: "text-sm font-medium",
																				children: t(
																					"settings:codeIndex.openAiCompatibleApiKeyLabel",
																				),
																			}),
																			_jsx(VSCodeTextField, {
																				type: "password",
																	...
																	_jsxs("div", {
																		...
																		children: [
																			_jsx("label", {
																				className: "text-sm font-medium",
																				children: t(
																					"settings:codeIndex.geminiApiKeyLabel",
																				),
																			}),
																			_jsx(VSCodeTextField, {
																				type: "password",
																	...
																	_jsxs("div", {
																		...
																		children: [
																			_jsx("label", {
																				className: "text-sm font-medium",
																				children: t(
																					"settings:codeIndex.mistralApiKeyLabel",
																				),
																			}),
																			_jsx(VSCodeTextField, {
																				type: "password",
																	...
																	_jsxs("div", {
																		...
																		children: [
																			_jsx("label", {
																				className: "text-sm font-medium",
																				children: t(
																					"settings:codeIndex.vercelAiGatewayApiKeyLabel",
																				),
																			}),
																			_jsx(VSCodeTextField, {
																				type: "password",
																	...
																	_jsxs("div", {
																		...
																		children: [
																			_jsx("label", {
																				className: "text-sm font-medium",
																				children: t(
																					"settings:codeIndex.openRouterApiKeyLabel",
																				),
																			}),
																			_jsx(VSCodeTextField, {
																				type: "password",
														...
														_jsxs("div", {
															...
															children: [
																_jsx("label", {
																	className: "text-sm font-medium",
																	children: t("settings:codeIndex.qdrantUrlLabel"),
																}),
																_jsx(VSCodeTextField, {
																	...
																	onBlur: (e) => {
																		...
																		if (!e.target.value.trim()) {
																			currentSettings.codebaseIndexQdrantUrl =
																				DEFAULT_QDRANT_URL
																			updateSetting(
																				"codebaseIndexQdrantUrl",
																				DEFAULT_QDRANT_URL,
																...
																formErrors.codebaseIndexQdrantUrl &&
																	_jsx("p", {
																		className:
																			"text-xs text-vscode-errorForeground mt-1 mb-0",
																		children: formErrors.codebaseIndexQdrantUrl,
																	}),
															],
														}),
														_jsxs("div", {
															...
															children: [
																_jsx("label", {
																	className: "text-sm font-medium",
																	children: t("settings:codeIndex.qdrantApiKeyLabel"),
																}),
																_jsx(VSCodeTextField, {
																	type: "password",
																...
																formErrors.codeIndexQdrantApiKey &&
																	_jsx("p", {
																		className:
																			"text-xs text-vscode-errorForeground mt-1 mb-0",
																		children: formErrors.codeIndexQdrantApiKey,
																	}),
															],
														}),
													],
										...
										children: [
											_jsxs("button", {
												...
												children: [
													...
													_jsx("span", {
														className: "text-base font-semibold",
														children: t("settings:codeIndex.advancedConfigLabel"),
													}),
												],
											}),
																...
																_jsxs("div", {
																	...
																	children: [
																		_jsx("label", {
																			className: "text-sm font-medium",
																			children: t(
																				"settings:codeIndex.searchMinScoreLabel",
																			),
																		}),
																		_jsx(StandardTooltip, {
																			content: t(
																...
																_jsxs("div", {
																	...
																	children: [
																		...
																		_jsx(VSCodeButton, {
																			appearance: "icon",
																			title: t(
																				"settings:codeIndex.resetToDefault",
																			),
																			onClick: () =>
																				updateSetting(
																					"codebaseIndexSearchMinScore",
																...
																_jsxs("div", {
																	...
																	children: [
																		_jsx("label", {
																			className: "text-sm font-medium",
																			children: t(
																				"settings:codeIndex.searchMaxResultsLabel",
																			),
																		}),
																		_jsx(StandardTooltip, {
																			content: t(
												...
												children: [
													currentSettings.codebaseIndexEnabled &&
														...
														_jsx(VSCodeButton, {
															...
															children: t("settings:codeIndex.startIndexingButton"),
														}),
													currentSettings.codebaseIndexEnabled &&
															...
															children: [
																_jsx(AlertDialogTrigger, {
																	...
																	children: _jsx(VSCodeButton, {
																		...
																		children: t(
																			"settings:codeIndex.clearIndexDataButton",
																		),
																	}),
																}),
																		...
																		_jsxs(AlertDialogHeader, {
																			children: [
																				_jsx(AlertDialogTitle, {
																					children: t(
																						"settings:codeIndex.clearDataDialog.title",
																					),
																				}),
									...
									saveStatus === "error" &&
										_jsx("div", {
											className: "mt-2",
											children: _jsx("span", {
												className: "text-sm text-vscode-errorForeground block",
												children: saveError || t("settings:codeIndex.saveError"),
											}),
										}),
								],
							}),
