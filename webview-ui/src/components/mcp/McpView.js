	...
	return _jsxs(Tab, {
		children: [
			_jsxs(TabHeader, {
				...
				children: [
					_jsx("h3", { className: "text-vscode-foreground m-0", children: t("mcp:title") }),
					_jsx(Button, { onClick: onDone, children: t("mcp:done") }),
				],
			}),
			_jsxs(TabContent, {
				children: [
							...
							children: [
									...
									children: [
										_jsx(VSCodeCheckbox, {
											...
											children: _jsx("span", {
												...
												children: t("mcp:enableServerCreation.title"),
											}),
										}),
										_jsxs("div", {
											style: {
												...
												_jsxs(Trans, {
													...
													children: [
														_jsx(VSCodeLink, {
															...
															style: { display: "inline" },
															children: "Learn about server creation",
														}),
														_jsx("strong", { children: "new" }),
													],
												}),
												_jsx("p", {
													style: { marginTop: "8px" },
													children: t("mcp:enableServerCreation.hint"),
												}),
											],
										}),
									],
								...
								servers.length > 0 &&
									_jsx("div", {
										...
										children: servers.map((server) =>
											_jsx(
												ServerRow,
												{ server: server, alwaysAllowMcp: alwaysAllowMcp },
								...
								_jsx("div", {
									...
									children: _jsx(VSCodeLink, {
										...
										style: { display: "inline" },
										children: t("mcp:learnMoreEditingSettings"),
									}),
								}),
							],
						}),
					...
					_jsxs("div", {
						...
						children: [
							_jsxs(VSCodePanels, {
								style: { marginBottom: "10px" },
								children: [
									_jsxs(VSCodePanelTab, {
										id: "tools",
										children: [t("mcp:tabs.tools"), " (", server.tools?.length || 0, ")"],
									}),
									_jsxs(VSCodePanelTab, {
										id: "resources",
										children: [
									...
									server.instructions &&
										_jsx(VSCodePanelTab, { id: "instructions", children: t("mcp:instructions") }),
									_jsxs(VSCodePanelTab, {
										id: "logs",
										children: [t("mcp:tabs.logs"), " (", server.errorHistory?.length || 0, ")"],
									}),
									_jsx(VSCodePanelView, {
										id: "tools-view",
										children:
												...
												? _jsx("div", {
														...
														children: server.tools.map((tool) =>
															_jsx(
																...
																`${tool.name}-${server.name}-${server.source || "global"}`,
															),
														),
													})
												: _jsx("div", {
														...
														children: t("mcp:emptyState.noTools"),
													}),
									}),
									_jsx(VSCodePanelView, {
										id: "resources-view",
										children:
											...
											(server.resourceTemplates && server.resourceTemplates.length > 0)
												...
												: _jsx("div", {
														...
														children: t("mcp:emptyState.noResources"),
													}),
									}),
									server.instructions &&
										_jsx(VSCodePanelView, {
											...
											children: _jsx("div", {
												...
												children: _jsx("div", {
													className: "opacity-80 whitespace-pre-wrap break-words",
										...
										children:
											server.errorHistory && server.errorHistory.length > 0
												...
												: _jsx("div", {
														...
														children: t("mcp:emptyState.noLogs"),
													}),
									}),
								],
							}),
							_jsxs("div", {
								...
								children: [
									_jsxs("div", {
										...
										children: [
											_jsx("span", { children: t("mcp:networkTimeout.label") }),
											_jsx("select", {
												value: timeoutValue,
			...
			_jsx(Dialog, {
				...
				children: _jsxs(DialogContent, {
					children: [
						_jsxs(DialogHeader, {
							children: [
								_jsx(DialogTitle, { children: t("mcp:deleteDialog.title") }),
								_jsx(DialogDescription, {
									children: t("mcp:deleteDialog.description", { serverName: server.name }),
								}),
							],
						}),
						_jsxs(DialogFooter, {
							children: [
								_jsx(Button, {
									...
									children: t("mcp:deleteDialog.cancel"),
								}),
								_jsx(Button, {
									variant: "default",
									onClick: handleDelete,
									children: t("mcp:deleteDialog.delete"),
								}),
							],
						}),
					],
