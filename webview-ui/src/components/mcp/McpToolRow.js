...
const McpToolRow = ({ tool, serverName, serverSource, alwaysAllowMcp, isInChatContext = false }) => {
	...
	return _jsxs(
		"div",
		{
			className: "py-2 border-b border-vscode-panel-border last:border-b-0",
			children: [
				_jsxs("div", {
								...
								children: [
									alwaysAllowMcp &&
										...
										_jsx(VSCodeCheckbox, {
											...
											className: "text-xs",
											children: _jsx("span", {
												className: "text-vscode-descriptionForeground whitespace-nowrap",
												children: t("mcp:tool.alwaysAllow"),
											}),
										}),
									!isInChatContext &&
										_jsx(StandardTooltip, {
											content: t("mcp:tool.togglePromptInclusion"),
				...
				isToolEnabled &&
					...
					_jsxs("div", {
						className: "mt-2 text-xs border border-vscode-panel-border rounded p-2",
						children: [
							_jsx("div", {
								className: "mb-1 text-[11px] uppercase opacity-80 text-vscode-descriptionForeground",
								children: t("mcp:tool.parameters"),
							}),
							Object.entries(tool.inputSchema.properties).map(([paramName, schema]) => {
								...
								return _jsxs(
									"div",
									{
										...
										children: [
											_jsxs("code", {
												className: "text-vscode-textPreformat-foreground mr-2",
												children: [
													paramName,
													isRequired &&
														_jsx("span", {
											...
											_jsx("span", {
												className: "opacity-80 break-words text-vscode-descriptionForeground",
												children: schema.description || t("mcp:tool.noDescription"),
											}),
										],
									},
									paramName,
