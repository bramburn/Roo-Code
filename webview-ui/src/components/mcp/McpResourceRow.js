...
const McpResourceRow = ({ item }) => {
    ...
    return (_jsxs("div", { style: {
            padding: "3px 0",
                    ...
                    alignItems: "center",
                    marginBottom: "4px",
                }, children: [_jsx("span", { className: `codicon codicon-symbol-file`, style: { marginRight: "6px" } }), _jsx("span", { style: { fontWeight: 500, wordBreak: "break-all" }, children: uri })] }), _jsx("div", { style: {
                    fontSize: "12px",
                    opacity: 0.8,
                    margin: "4px 0",
