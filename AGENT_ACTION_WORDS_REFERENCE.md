...
This document provides a quick reference for all agent-specific action words defined in `prompter.md`. Use this as a cheat sheet when writing agent instructions.
...
**Good**: `VALIDATE_COMPLIANCE PRDs/05-analytics/ WITH [INSTRUCTION.md] GENERATING compliance_report.md`
...
- **prompter.md**: Full agent templates with Sequential Thinking protocols
- **PROMPTER_AGENT_TEMPLATES_SUMMARY.md**: Detailed summary of all agent templates
- **INSTRUCTION.md**: PRD structure and content requirements
