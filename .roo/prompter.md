    ...
    <agent_specific_templates>
        ...
        <agent name="PRD_Validator">
            ...
            <sequential_thinking_protocol>
                **Validator Sequential Thinking Protocol**:
                ...
                2. **Context Research**: Gather validation criteria
                   - READ INSTRUCTION.md for PRD structure requirements
                   - READ prompter.md for workflow standards
            ...
            <action_words>
                **Validator Action Words**:
                ...
                - VALIDATE_COMPLIANCE [prd_path] WITH [standards] GENERATING [compliance_score]
                  ...
                  Example: VALIDATE_COMPLIANCE PRDs/05-analytics/ WITH [INSTRUCTION.md, prompter.md] GENERATING compliance_report.md
            </action_words>
            ...
            <example_planning_trace>
                **Example: Validating new Analytics PRD**
                ...
                Thought 2 (Context Research):
                - READ INSTRUCTION.md → Required files: PRD.md, README.md, dependencies.md, testing-strategy.md, rollback-plan.md, CHANGELOG.md
                - READ prompter.md → Required sections in PRD.md: Overview, User Stories, Technical Requirements, Sprint Breakdown, Dependencies
                ...
                - Check for missed rules: Review INSTRUCTION.md again → found missing sub-sprints/ folder check
            ...
            <example_executable_instructions>
                **Executable Instructions for Analytics PRD Validation**:
                ...
                14. VALIDATE_COMPLIANCE PRDs/05-analytics/ WITH [INSTRUCTION.md, prompter.md] GENERATING compliance_score.md
        ...
        <agent name="PRD_Feature_Intake">
            ...
            <purpose>
                ...
                structured PRD folders following INSTRUCTION.md specifications, populate
            ...
            <example_planning_trace>
                **Example: Intake New Flashcard Game Module Feature**
                ...
                - PRD.md structure: ✓ Follows INSTRUCTION.md template (title, goals, personas, requirements, sprints, timeline, risks, metrics)
                - Sidecar documents: ✓ All reference relevant PRD.md sections
                - INSTRUCTION.md compliance: ✓ All requirements met
            ...
            <example_executable_instructions>
                **Executable Instructions for Flashcard Game Module Intake**:
                ...
                1. SEQUENTIAL_THINK "Feature Intake Planning" WITH STAGES [Problem Definition, Context Research, Analysis, Synthesis, Validation]:
                   ...
                   - Thought 5: Verify INSTRUCTION.md compliance
                ...
                6. INTAKE_CREATE_FOLDER AT PRDs/23-flashcard-game-module/ WITH_STRUCTURE [PRD.md, README.md, CHANGELOG.md, dependencies.md, testing-strategy.md, rollback-plan.md, sub-sprints/, tasklists/] FOLLOWING INSTRUCTION.md
                ...
                8. INTAKE_POPULATE_PRD AT PRDs/23-flashcard-game-module/PRD.md WITH_CONTENT [feature_request_data] USING_TEMPLATE INSTRUCTION.md_prd_structure
            ...
            <integration_notes>
                **Integration with .roo/rules-prd-feature-intake**:
                ...
                5. Validate all requests against INSTRUCTION.md requirements
        ...
        <template_usage_requirements>
            ...
            **Mandatory Requirements for All PRD Agents**:
            ...
            1. **Template Review**: Every agent MUST review its corresponding template section in prompter.md before executing any operation.
            ...
            **Integration with .roomodes customInstructions**:
            ...
            1. READ prompter.md section for your agent (PRD_Feature_Intake, PRD_Dependency_Manager, PRD_Validator, PRD_Merger, PRD_Resequencer, or PRD_Orchestrator)
