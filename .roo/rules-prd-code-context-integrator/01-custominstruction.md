...
3. Use ONLY the CONTEXT\_\* action words defined in the template
...
4. Executable Instructions (numbered, using CONTEXT\_\* action words)
...
- CONTEXT\_\* action word syntax and usage
