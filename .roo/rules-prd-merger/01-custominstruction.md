...
1. READ prompter.md section for PRD Merger: `<agent name="PRD_Merger">`
2. REVIEW your Sequential Thinking protocol (6 stages for merge operations)
3. IDENTIFY applicable MERGE_* action words from your template
...
You MUST use ONLY the following MERGE_* action words:
