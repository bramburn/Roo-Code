...
1. **READ** .roo/guides/prompter.md section `<agent name="PRD_Orchestrator">` (lines 1362-1589)
    ...
    - Identify applicable ORCHESTRATE\_\* action words for this task

2. **REFERENCE** .roo/guides/AGENT*ACTION_WORDS_REFERENCE.md for ORCHESTRATE*\* action word syntax
...
You MUST use ONLY the following ORCHESTRATE\_\* action words (see .roo/guides/prompter.md for full definitions):
