...
2. **REFERENCE** AGENT_ACTION_WORDS_REFERENCE.md for ORCHESTRATE_* action word syntax
...
You MUST use ONLY the following ORCHESTRATE_* action words (see prompter.md for full definitions):
...
See prompter.md `<action_words>` section (lines 402-420) and AGENT_ACTION_WORDS_REFERENCE.md (lines 258-294) for full syntax and examples.
...
See prompter.md `<example_executable_instructions>` (lines 1362-1589) for format.
