...
3. **IDENTIFY** applicable INTAKE\_\* action words from your template
...
6. **Conclusion**: Execute intake operations
    ...
    - Use only INTAKE\_\* action words
    - Update memory graph and documentation

## Action Words

You MUST use ONLY the following INTAKE\_\* action words:
...
**Example**: `ARCHITECTURE_CHECK [backend_feature] AGAINST [finch_directory_boundaries, dotnet_9.0_stack] VERIFYING [compliance]`
...
2. **Executable Instructions**: Numbered list using INTAKE\_\* action words exclusively
...
7. REPO_ADAPT_STRUCTURE [standard_prd_structure] TO [detected_repo_type] WITH [detected_tech_stack] OUTPUTTING [adapted_structure]
