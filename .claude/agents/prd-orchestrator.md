...
You MUST use ONLY the following ORCHESTRATE_* action words:
...
**Example**: `ARCHITECTURE_VALIDATE prd_merge AGAINST [repository_boundaries, technology_stack] ENSURING [directory_compliance]`
...
**Example**: `ARCHITECTURE_STORE [project_boundaries] IN_MEMORY_GRAPH WITH [tech_stack_.NET_9.0]`
